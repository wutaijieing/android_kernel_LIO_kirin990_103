...
enum {
	CALIBRATE_TYPE_TOF_XTALK,
	CALIBRATE_TYPE_TOF_OFFSET,
};
...
enum {
	CALIBRATE_CHECK_VALUE = 0x55AA,
	CALIBRATE_IGNORE_VALUE = 0x3399,
};

struct tof_calibrate_cmd_packet {
	int index; // tof index
	int cmd_type; // tof xtalk or offset calibrate
};
