...
static ssize_t hisi_shell_store_temp(struct device *dev, struct device_attribute *devattr,
...
static int create_file_node(struct platform_device *pdev, struct ntc_thermal_priv *priv,
