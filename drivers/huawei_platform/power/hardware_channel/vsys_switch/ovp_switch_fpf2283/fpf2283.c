...
#ifdef CONFIG_HUAWEI_POWER_DEBUG
static ssize_t fpf2283_dbg_reg_value_show(void *dev_data,
...
static ssize_t fpf2283_dbg_reg_value_store(void *dev_data,
...
#ifdef CONFIG_HUAWEI_POWER_DEBUG
	power_dbg_ops_register("fpf2283", "reg_value", i2c_get_clientdata(client),
		fpf2283_dbg_reg_value_show,
		fpf2283_dbg_reg_value_store);
#endif /* CONFIG_HUAWEI_POWER_DEBUG */
