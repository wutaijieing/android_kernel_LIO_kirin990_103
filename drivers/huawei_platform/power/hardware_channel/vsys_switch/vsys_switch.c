...
static void vsys_switch_calc_avg_batt_para(struct vsys_switch_device_info *di)
{
	...
	ibatt_sample = power_platform_get_battery_current();
...
static ssize_t vsys_switch_dbg_switch_vsys_show(void *dev_data,
...
static ssize_t vsys_switch_dbg_switch_vsys_store(const void *dev_data,
	char *buf, size_t size)
{
	struct vsys_switch_device_info *dev_p = dev_data;
	struct vsys_switch_device_info *di = g_vsys_switch_di;
...
static ssize_t vsys_switch_dbg_enable_sc_show(void *dev_data,
	char *buf, size_t size)
{
	struct vsys_switch_device_info *dev_p = dev_data;
	struct vsys_switch_device_info *di = g_vsys_switch_di;
...
static ssize_t vsys_switch_dbg_enable_sc_store(void *dev_data,
...
static ssize_t vsys_switch_dbg_enable_buck_show(void *dev_data,
	char *buf, size_t size)
{
	struct vsys_switch_device_info *dev_p = dev_data;
	struct vsys_switch_device_info *di = g_vsys_switch_di;
...
static ssize_t vsys_switch_dbg_enable_buck_store(void *dev_data,
	const char *buf, size_t size)
{
	struct vsys_switch_device_info *dev_p = dev_data;
	struct vsys_switch_device_info *di = g_vsys_switch_di;
...
static ssize_t vsys_switch_dbg_vbatt_threshold_show(void *dev_data,
	char *buf, size_t size)
{
	struct vsys_switch_device_info *dev_p = dev_data;
	struct vsys_switch_device_info *di = g_vsys_switch_di;
...
static ssize_t vsys_switch_dbg_vbatt_threshold_store(void *dev_data,
	const char *buf, size_t size)
{
	struct vsys_switch_device_info *dev_p = dev_data;
	struct vsys_switch_device_info *di = g_vsys_switch_di;
...
static ssize_t vsys_switch_dbg_vsys_volt_show(void *dev_data,
	char *buf, size_t size)
{
	struct vsys_switch_device_info *dev_p = dev_data;
	struct vsys_switch_device_info *di = g_vsys_switch_di;
...
static ssize_t vsys_switch_dbg_vsys_volt_store(void *dev_data,
	const char *buf, size_t size)
{
	struct vsys_switch_device_info *dev_p = dev_data;
	int val = 0;
...
static ssize_t vsys_switch_dbg_vsys_chnl_show(void *dev_data,
	char *buf, size_t size)
{
	struct vsys_switch_device_info *dev_p = dev_data;
	struct vsys_switch_device_info *di = g_vsys_switch_di;
...
static ssize_t vsys_switch_dbg_vsys_chnl_store(void *dev_data,
	const char *buf, size_t size)
{
	struct vsys_switch_device_info *dev_p = dev_data;
	int val = 0;
...
static int vsys_switch_probe(struct platform_device *pdev)
{
	...
	di->wakelock = power_wakeup_source_register(di->dev, "vsys_switch_wakelock");
...
#ifdef CONFIG_HUAWEI_POWER_DEBUG
	power_dbg_ops_register("vsys_switch", "switch_vsys", platform_get_drvdata(pdev),
		vsys_switch_dbg_switch_vsys_show,
		vsys_switch_dbg_switch_vsys_store);
	power_dbg_ops_register("vsys_switch", "enable_sc", platform_get_drvdata(pdev),
		vsys_switch_dbg_enable_sc_show,
		vsys_switch_dbg_enable_sc_store);
	power_dbg_ops_register("vsys_switch", "enable_buck", platform_get_drvdata(pdev),
		vsys_switch_dbg_enable_buck_show,
		vsys_switch_dbg_enable_buck_store);
	power_dbg_ops_register("vsys_switch", "vbatt_threshold", platform_get_drvdata(pdev),
		vsys_switch_dbg_vbatt_threshold_show,
		vsys_switch_dbg_vbatt_threshold_store);
	power_dbg_ops_register("vsys_switch", "vsys_volt", platform_get_drvdata(pdev),
		vsys_switch_dbg_vsys_volt_show,
		vsys_switch_dbg_vsys_volt_store);
	power_dbg_ops_register("vsys_switch", "vsys_chnl", platform_get_drvdata(pdev),
		vsys_switch_dbg_vsys_chnl_show,
		vsys_switch_dbg_vsys_chnl_store);
#endif /* CONFIG_HUAWEI_POWER_DEBUG */
