...
#ifdef CONFIG_HUAWEI_POWER_DEBUG
static ssize_t tps62180_dbg_buck_vout_show(void *dev_data,
...
static ssize_t tps62180_dbg_buck_vout_store(void *dev_data,
...
static ssize_t tps62180_dbg_buck_state_show(void *dev_data,
	char *buf, size_t size)
{
	struct tps62180_device_info *dev_p = dev_data;
	int state;
...
static ssize_t tps62180_dbg_buck_state_store(void *dev_data,
	const char *buf, size_t size)
{
	struct tps62180_device_info *dev_p = dev_data;
	int state = 0;
...
#ifdef CONFIG_HUAWEI_POWER_DEBUG
	power_dbg_ops_register("tps62180", "buck_vout", platform_get_drvdata(pdev),
		tps62180_dbg_buck_vout_show,
		tps62180_dbg_buck_vout_store);
	power_dbg_ops_register("tps62180", "buck_state", platform_get_drvdata(pdev),
		tps62180_dbg_buck_state_show,
		tps62180_dbg_buck_state_store);
#endif /* CONFIG_HUAWEI_POWER_DEBUG */
