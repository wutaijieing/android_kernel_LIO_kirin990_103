...
void nxp_sha224_init(struct sha224_t *context)
{
	if (!context)
		return;
...
void nxp_sha224_update(struct sha224_t *context,
...
void nxp_sha224_final(struct sha224_t *context, uint8_t *digest)
{
	uint32_t block_nb;
	uint32_t pm_len;
	uint32_t len_b;
