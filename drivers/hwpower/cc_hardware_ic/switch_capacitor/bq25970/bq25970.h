...
/* Hidden register, to open ADC when not enable charge mode */
#define SC8551A_ADC_OPEN_REG                0x3C
#define SC8551A_ADC_IBAT_OPEN_MASK          BIT(7)
#define SC8551A_ADC_IBAT_OPEN_SHIFT         7
