...
extern void usb_notify_set_address_err(struct usb_bus *ubus);
extern void usb_notify_get_descriptor_err(struct usb_bus *ubus);
extern void usb_notify_enum_dev_unknown_err(struct usb_bus *ubus);
extern void usb_notify_transfer_err(struct usb_bus *ubus);
#else
static inline void usb_notify_set_address_err(struct usb_bus *ubus) { };
static inline void usb_notify_get_descriptor_err(struct usb_bus *ubus) { };
static inline void usb_notify_enum_dev_unknown_err(struct usb_bus *ubus) { };
static inline void usb_notify_transfer_err(struct usb_bus *ubus) { };
#endif
