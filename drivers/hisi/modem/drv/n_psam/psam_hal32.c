...
const unsigned int g_psam32_setting_table[][2] = {
    { HI_PSAM_ADQ_CTRL_OFFSET, 0xfffffff0 },    { HI_PSAM32_ADQ0_BASE_OFFSET, 0xffffffff },
    { HI_PSAM_ADQ0_RPTR_OFFSET, 0xffffffff },   { HI_PSAM_ADQ0_WPTR_OFFSET, 0xffffffff },
    { HI_PSAM32_ADQ1_BASE_OFFSET, 0xffffffff }, { HI_PSAM_ADQ1_WPTR_OFFSET, 0xffffffff },
    { HI_PSAM_ADQ1_RPTR_OFFSET, 0xffffffff },   { HI_PSAM_ADQ_CTRL_OFFSET, 0xffffffff },
};
