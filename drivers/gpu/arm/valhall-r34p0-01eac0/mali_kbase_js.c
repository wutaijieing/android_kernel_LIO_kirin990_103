		...
		ktime_t *end_timestamp)
{
...
#ifdef CONFIG_MALI_GPU_CL_BOOST
	if (end_timestamp != NULL) {
		...
		if (kbdev->gpu_dev_data.callbacks->cl_boost_update_utilization)
			kbdev->gpu_dev_data.callbacks->cl_boost_update_utilization(kbdev,
