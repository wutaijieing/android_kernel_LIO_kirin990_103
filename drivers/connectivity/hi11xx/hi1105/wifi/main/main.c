...
static const oal_wlan_cfg_stru g_wlan_spec_cfg_hi1103 = {
    ...
    .max_tx_ampdu_num = WLAN_AMPDU_TX_MAX_NUM_1103,
    .max_rf_num = 2,
    .feature_txq_ns_support = OAL_FALSE,
    .feature_txbf_mib_study = OAL_TRUE,
    .bfee_support_ants = 4,        /* 03最多支持 4*2 MU Sounding */
    .bfer_sounding_dimensions = 1, /* 发送最多支持单流 */
    .vht_bfee_ntx_supports = 4,    /* 03最多支持 4*2 MU Sounding */
    .vht_max_mpdu_lenth = WLAN_MIB_VHT_MPDU_7991, /* VHT协议05最大mpdu_len */
...
static const oal_wlan_cfg_stru g_wlan_spec_cfg_hi1105 = {
    ...
    .max_tx_ampdu_num = WLAN_AMPDU_TX_MAX_NUM_1105,
    .max_rf_num = 2,
    .feature_txq_ns_support = OAL_FALSE,
    .feature_txbf_mib_study = OAL_TRUE,
    .bfee_support_ants = 8,        /* 05最多支持 8*2 MU Sounding */
    .bfer_sounding_dimensions = 1, /* 发送最多支持双流 */
    .vht_bfee_ntx_supports = 8,    /* 03最多支持 4*2 MU Sounding */
    .vht_max_mpdu_lenth = WLAN_MIB_VHT_MPDU_7991, /* VHT协议05最大mpdu_len */
    .trigger_su_beamforming_feedback = OAL_FALSE,
    .trigger_mu_partialbw_feedback = OAL_FALSE,
    .rx_stbc_160 = OAL_FALSE,
...
static const oal_wlan_cfg_stru g_wlan_spec_cfg_shenkuo = {
    .feature_m2s_modem_is_open = OAL_TRUE,
    .feature_priv_closed_is_open = OAL_FALSE,
    .feature_hiex_is_open = OAL_TRUE,
    .rx_listen_ps_is_open = OAL_TRUE,
    ...
    .max_p2p_group_num = 2,
    .p2p_go_max_user_num = WLAN_P2P_GO_ASSOC_USER_MAX_NUM_SHENKUO,  /* shenkuo P2P最大接入用户数为8 */
    ...
    .max_tx_ba = WLAN_MAX_TX_BA_SHENKUO,
    .max_rx_ba = WLAN_MAX_RX_BA_SHENKUO,
    .other_bss_id = WLAN_HAL_OHTER_BSS_ID_SHENKUO,
    .max_tx_ampdu_num = WLAN_AMPDU_TX_MAX_NUM_SHENKUO,
    .max_rf_num = 4,
    .feature_txq_ns_support = OAL_TRUE,
    .feature_txbf_mib_study = OAL_TRUE,
    .bfee_support_ants = 8,        /* shenkuo 最多支持 8*4 MU Sounding */
    .bfer_sounding_dimensions = 4, /* 发送最多支持4流 */
    .vht_bfee_ntx_supports = 8,    /* shenkuo 最多支持 8*4 MU Sounding */
    .vht_max_mpdu_lenth = WLAN_MIB_VHT_MPDU_11454, /* VHT协议shenkuo最大mpdu_len */
    .trigger_su_beamforming_feedback = OAL_TRUE,
    .trigger_mu_partialbw_feedback = OAL_TRUE,
...
static const oal_wlan_cfg_stru g_wlan_spec_cfg_bisheng = {
    ...
    .vht_max_mpdu_lenth = WLAN_MIB_VHT_MPDU_11454, /* VHT协议bisheng最大mpdu_len */
    .trigger_su_beamforming_feedback = OAL_FALSE,
    .trigger_mu_partialbw_feedback = OAL_FALSE,
    .rx_stbc_160 = OAL_TRUE,
    .num_different_channels = 3,
...
oal_wlan_cfg_stru *g_wlan_spec_cfg = &g_wlan_spec_cfg_shenkuo;
...
static int32_t wifi_feature_switch_cfg_init(void)
{
    ...
    if (is_hisi_chiptype(BOARD_VERSION_HI1103)) {
        ...
        g_wlan_spec_cfg = &g_wlan_spec_cfg_shenkuo;
...
int32_t wifi_sysfs_init(void)
{
    ...
    if ((is_hisi_chiptype(BOARD_VERSION_HI1103) == false) &&
        ...
        (is_hisi_chiptype(BOARD_VERSION_SHENKUO) == false) &&
        (is_hisi_chiptype(BOARD_VERSION_BISHENG) == false) &&
        (is_hisi_chiptype(BOARD_VERSION_HI1161) == false)) {
        return OAL_SUCC;
    }
