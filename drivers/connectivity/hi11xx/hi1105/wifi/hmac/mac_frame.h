...
#define mac_is_netgear_rax20(pst_bss_dscr)                                            \
    ((0x28 == (pst_bss_dscr)->auc_bssid[0]) && (0x80 == (pst_bss_dscr)->auc_bssid[1]) && \
        (0x88 == (pst_bss_dscr)->auc_bssid[2]) && (WLAN_AP_CHIP_OUI_BCM == (pst_bss_dscr)->en_is_tplink_oui))
