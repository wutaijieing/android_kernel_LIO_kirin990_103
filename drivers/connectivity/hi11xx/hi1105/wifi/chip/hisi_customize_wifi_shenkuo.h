...
#ifndef __HISI_CUSTOMIZE_WIFI_SHENKUO_H__
#define __HISI_CUSTOMIZE_WIFI_SHENKUO_H__
...
uint32_t hwifi_get_sar_ctrl_params_shenkuo(uint8_t lvl_num, uint8_t *data_addr, uint16_t *data_len, uint16_t dest_len);
#endif  // hisi_customize_wifi_shenkuo.h
