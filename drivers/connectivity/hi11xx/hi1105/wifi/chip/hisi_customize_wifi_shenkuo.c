...
mac_cust_feature_cap_stru g_cust_cap = {
    ...
    .hisi_priv_cap = 0, /* 私有IE能力，05通过该默认值获取，shenkuo 会通过INI文件读取 */
...
wlan_cust_pow_stru g_cust_pow = {
    .fcc_ce_param = {
        {.rf_id = WLAN_SINGLE_STREAM_0}, {.rf_id = WLAN_SINGLE_STREAM_1},
        {.rf_id = WLAN_SINGLE_STREAM_2}, {.rf_id = WLAN_SINGLE_STREAM_3}
    }
};
...
static wlan_cust_cfg_cmd g_wifi_cfg_dyn_pow[] = {
    ...
    {"dpn2g_11b_core0", WLAN_CFG_DYN_POW_2G_CORE0_DPN_11B,
     ...
     sizeof(int8_t),
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[0][WLAN_RF_CHANNEL_ZERO].dpn_2g[DYN_PWR_CUST_SNGL_MODE_11B]), OAL_FALSE},
    {"dpn2g_11b_core1", WLAN_CFG_DYN_POW_2G_CORE1_DPN_11B,
     ...
     sizeof(int8_t),
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[0][WLAN_RF_CHANNEL_ONE].dpn_2g[DYN_PWR_CUST_SNGL_MODE_11B]), OAL_FALSE},
    {"dpn2g_11b_core2", WLAN_CFG_DYN_POW_2G_CORE2_DPN_11B,
     ...
     sizeof(int8_t),
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[0][WLAN_RF_CHANNEL_TWO].dpn_2g[DYN_PWR_CUST_SNGL_MODE_11B]), OAL_FALSE},
    {"dpn2g_11b_core3", WLAN_CFG_DYN_POW_2G_CORE3_DPN_11B,
     ...
     sizeof(int8_t),
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[0][WLAN_RF_CHANNEL_THREE].dpn_2g[DYN_PWR_CUST_SNGL_MODE_11B]), OAL_FALSE},
    {"dpn2g_20m_core0", WLAN_CFG_DYN_POW_2G_CORE0_DPN_OFDM_20M,
     ...
     sizeof(int8_t),
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[0][WLAN_RF_CHANNEL_ZERO].dpn_2g[DYN_PWR_CUST_SNGL_MODE_OFDM20]), OAL_FALSE},
    {"dpn2g_20m_core1", WLAN_CFG_DYN_POW_2G_CORE1_DPN_OFDM_20M,
     ...
     sizeof(int8_t),
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[0][WLAN_RF_CHANNEL_ONE].dpn_2g[DYN_PWR_CUST_SNGL_MODE_OFDM20]), OAL_FALSE},
    {"dpn2g_20m_core2", WLAN_CFG_DYN_POW_2G_CORE2_DPN_OFDM_20M,
     ...
     sizeof(int8_t),
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[0][WLAN_RF_CHANNEL_TWO].dpn_2g[DYN_PWR_CUST_SNGL_MODE_OFDM20]), OAL_FALSE},
    {"dpn2g_20m_core3", WLAN_CFG_DYN_POW_2G_CORE3_DPN_OFDM_20M,
     ...
     sizeof(int8_t),
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[0][WLAN_RF_CHANNEL_THREE].dpn_2g[DYN_PWR_CUST_SNGL_MODE_OFDM20]), OAL_FALSE},
    {"dpn2g_40m_core0", WLAN_CFG_DYN_POW_2G_CORE0_DPN_OFDM_40M,
     ...
     sizeof(int8_t),
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[0][WLAN_RF_CHANNEL_ZERO].dpn_2g[DYN_PWR_CUST_SNGL_MODE_OFDM40]), OAL_FALSE},
    {"dpn2g_40m_core1", WLAN_CFG_DYN_POW_2G_CORE1_DPN_OFDM_40M,
     ...
     sizeof(int8_t),
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[0][WLAN_RF_CHANNEL_ONE].dpn_2g[DYN_PWR_CUST_SNGL_MODE_OFDM40]), OAL_FALSE},
    {"dpn2g_40m_core2", WLAN_CFG_DYN_POW_2G_CORE2_DPN_OFDM_40M,
     ...
     sizeof(int8_t),
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[0][WLAN_RF_CHANNEL_TWO].dpn_2g[DYN_PWR_CUST_SNGL_MODE_OFDM40]), OAL_FALSE},
    {"dpn2g_40m_core3", WLAN_CFG_DYN_POW_2G_CORE3_DPN_OFDM_40M,
     ...
     sizeof(int8_t),
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[0][WLAN_RF_CHANNEL_THREE].dpn_2g[DYN_PWR_CUST_SNGL_MODE_OFDM40]), OAL_FALSE},
    {"dpn5g_20m_core0", WLAN_CFG_DYN_POW_5G_CORE0_DPN_20M,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[0][WLAN_RF_CHANNEL_ZERO].dpn_5g[WLAN_BW_CAP_20M]), OAL_FALSE},
    {"dpn5g_20m_core1", WLAN_CFG_DYN_POW_5G_CORE1_DPN_20M,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[0][WLAN_RF_CHANNEL_ONE].dpn_5g[WLAN_BW_CAP_20M]), OAL_FALSE},
    {"dpn5g_20m_core2", WLAN_CFG_DYN_POW_5G_CORE2_DPN_20M,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[0][WLAN_RF_CHANNEL_TWO].dpn_5g[WLAN_BW_CAP_20M]), OAL_FALSE},
    {"dpn5g_20m_core3", WLAN_CFG_DYN_POW_5G_CORE3_DPN_20M,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[0][WLAN_RF_CHANNEL_THREE].dpn_5g[WLAN_BW_CAP_20M]), OAL_FALSE},
    {"dpn5g_40m_core0", WLAN_CFG_DYN_POW_5G_CORE0_DPN_40M,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[0][WLAN_RF_CHANNEL_ZERO].dpn_5g[WLAN_BW_CAP_40M]), OAL_FALSE},
    {"dpn5g_40m_core1", WLAN_CFG_DYN_POW_5G_CORE1_DPN_40M,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[0][WLAN_RF_CHANNEL_ONE].dpn_5g[WLAN_BW_CAP_40M]), OAL_FALSE},
    {"dpn5g_40m_core2", WLAN_CFG_DYN_POW_5G_CORE2_DPN_40M,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[0][WLAN_RF_CHANNEL_TWO].dpn_5g[WLAN_BW_CAP_40M]), OAL_FALSE},
    {"dpn5g_40m_core3", WLAN_CFG_DYN_POW_5G_CORE3_DPN_40M,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[0][WLAN_RF_CHANNEL_THREE].dpn_5g[WLAN_BW_CAP_40M]), OAL_FALSE},
    {"dpn5g_80m_core0", WLAN_CFG_DYN_POW_5G_CORE0_DPN_80M,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[0][WLAN_RF_CHANNEL_ZERO].dpn_5g[WLAN_BW_CAP_80M]), OAL_FALSE},
    {"dpn5g_80m_core1", WLAN_CFG_DYN_POW_5G_CORE1_DPN_80M,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[0][WLAN_RF_CHANNEL_ONE].dpn_5g[WLAN_BW_CAP_80M]), OAL_FALSE},
    {"dpn5g_80m_core2", WLAN_CFG_DYN_POW_5G_CORE2_DPN_80M,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[0][WLAN_RF_CHANNEL_TWO].dpn_5g[WLAN_BW_CAP_80M]), OAL_FALSE},
    {"dpn5g_80m_core3", WLAN_CFG_DYN_POW_5G_CORE3_DPN_80M,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[0][WLAN_RF_CHANNEL_THREE].dpn_5g[WLAN_BW_CAP_80M]), OAL_FALSE},
    {"dpn5g_160m_core0", WLAN_CFG_DYN_POW_5G_CORE0_DPN_160M,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[0][WLAN_RF_CHANNEL_ZERO].dpn_5g[WLAN_BW_CAP_160M]), OAL_FALSE},
    {"dpn5g_160m_core1", WLAN_CFG_DYN_POW_5G_CORE1_DPN_160M,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[0][WLAN_RF_CHANNEL_ONE].dpn_5g[WLAN_BW_CAP_160M]), OAL_FALSE},
    {"dpn5g_160m_core2", WLAN_CFG_DYN_POW_5G_CORE2_DPN_160M,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[0][WLAN_RF_CHANNEL_TWO].dpn_5g[WLAN_BW_CAP_160M]), OAL_FALSE},
    {"dpn5g_160m_core3", WLAN_CFG_DYN_POW_5G_CORE3_DPN_160M,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[0][WLAN_RF_CHANNEL_THREE].dpn_5g[WLAN_BW_CAP_160M]), OAL_FALSE},
#ifdef _PRE_WLAN_FEATURE_6G_EXTEND
    {"dpn6g_20m_core0", WLAN_CFG_DYN_POW_6G_CORE0_DPN_20M,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[0][WLAN_RF_CHANNEL_ZERO].dpn_6g[WLAN_BW_CAP_20M]), OAL_FALSE},
    {"dpn6g_20m_core1", WLAN_CFG_DYN_POW_6G_CORE1_DPN_20M,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[0][WLAN_RF_CHANNEL_ONE].dpn_6g[WLAN_BW_CAP_20M]), OAL_FALSE},
    {"dpn6g_20m_core2", WLAN_CFG_DYN_POW_6G_CORE2_DPN_20M,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[0][WLAN_RF_CHANNEL_TWO].dpn_6g[WLAN_BW_CAP_20M]), OAL_FALSE},
    {"dpn6g_20m_core3", WLAN_CFG_DYN_POW_6G_CORE3_DPN_20M,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[0][WLAN_RF_CHANNEL_THREE].dpn_6g[WLAN_BW_CAP_20M]), OAL_FALSE},
    {"dpn6g_40m_core0", WLAN_CFG_DYN_POW_6G_CORE0_DPN_40M,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[0][WLAN_RF_CHANNEL_ZERO].dpn_6g[WLAN_BW_CAP_40M]), OAL_FALSE},
    {"dpn6g_40m_core1", WLAN_CFG_DYN_POW_6G_CORE1_DPN_40M,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[0][WLAN_RF_CHANNEL_ONE].dpn_6g[WLAN_BW_CAP_40M]), OAL_FALSE},
    {"dpn6g_40m_core2", WLAN_CFG_DYN_POW_6G_CORE2_DPN_40M,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[0][WLAN_RF_CHANNEL_TWO].dpn_6g[WLAN_BW_CAP_40M]), OAL_FALSE},
    {"dpn6g_40m_core3", WLAN_CFG_DYN_POW_6G_CORE3_DPN_40M,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[0][WLAN_RF_CHANNEL_THREE].dpn_6g[WLAN_BW_CAP_40M]), OAL_FALSE},
    {"dpn6g_80m_core0", WLAN_CFG_DYN_POW_6G_CORE0_DPN_80M,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[0][WLAN_RF_CHANNEL_ZERO].dpn_6g[WLAN_BW_CAP_80M]), OAL_FALSE},
    {"dpn6g_80m_core1", WLAN_CFG_DYN_POW_6G_CORE1_DPN_80M,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[0][WLAN_RF_CHANNEL_ONE].dpn_6g[WLAN_BW_CAP_80M]), OAL_FALSE},
    {"dpn6g_80m_core2", WLAN_CFG_DYN_POW_6G_CORE2_DPN_80M,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[0][WLAN_RF_CHANNEL_TWO].dpn_6g[WLAN_BW_CAP_80M]), OAL_FALSE},
    {"dpn6g_80m_core3", WLAN_CFG_DYN_POW_6G_CORE3_DPN_80M,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[0][WLAN_RF_CHANNEL_THREE].dpn_6g[WLAN_BW_CAP_80M]), OAL_FALSE},
    {"dpn6g_160m_core0", WLAN_CFG_DYN_POW_6G_CORE0_DPN_160M,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[0][WLAN_RF_CHANNEL_ZERO].dpn_6g[WLAN_BW_CAP_160M]), OAL_FALSE},
    {"dpn6g_160m_core1", WLAN_CFG_DYN_POW_6G_CORE1_DPN_160M,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[0][WLAN_RF_CHANNEL_ONE].dpn_6g[WLAN_BW_CAP_160M]), OAL_FALSE},
    {"dpn6g_160m_core2", WLAN_CFG_DYN_POW_6G_CORE2_DPN_160M,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[0][WLAN_RF_CHANNEL_TWO].dpn_6g[WLAN_BW_CAP_160M]), OAL_FALSE},
    {"dpn6g_160m_core3", WLAN_CFG_DYN_POW_6G_CORE3_DPN_160M,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[0][WLAN_RF_CHANNEL_THREE].dpn_6g[WLAN_BW_CAP_160M]), OAL_FALSE},
#endif
    ...
    {"dpn2g_11b_core0_low", WLAN_CFG_DYN_POW_2G_CORE0_DPN_11B_LOW,
     ...
     sizeof(int8_t),
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[1][WLAN_RF_CHANNEL_ZERO].dpn_2g[DYN_PWR_CUST_SNGL_MODE_11B]), OAL_FALSE},
    {"dpn2g_11b_core1_low", WLAN_CFG_DYN_POW_2G_CORE1_DPN_11B_LOW,
     ...
     sizeof(int8_t),
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[1][WLAN_RF_CHANNEL_ONE].dpn_2g[DYN_PWR_CUST_SNGL_MODE_11B]), OAL_FALSE},
    {"dpn2g_11b_core2_low", WLAN_CFG_DYN_POW_2G_CORE2_DPN_11B_LOW,
     ...
     sizeof(int8_t),
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[1][WLAN_RF_CHANNEL_TWO].dpn_2g[DYN_PWR_CUST_SNGL_MODE_11B]), OAL_FALSE},
    {"dpn2g_11b_core3_low", WLAN_CFG_DYN_POW_2G_CORE3_DPN_11B_LOW,
     ...
     sizeof(int8_t),
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[1][WLAN_RF_CHANNEL_THREE].dpn_2g[DYN_PWR_CUST_SNGL_MODE_11B]), OAL_FALSE},
    {"dpn2g_20m_core0_low", WLAN_CFG_DYN_POW_2G_CORE0_DPN_OFDM_20M_LOW,
     ...
     sizeof(int8_t),
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[1][WLAN_RF_CHANNEL_ZERO].dpn_2g[DYN_PWR_CUST_SNGL_MODE_OFDM20]), OAL_FALSE},
    {"dpn2g_20m_core1_low", WLAN_CFG_DYN_POW_2G_CORE1_DPN_OFDM_20M_LOW,
     ...
     sizeof(int8_t),
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[1][WLAN_RF_CHANNEL_ONE].dpn_2g[DYN_PWR_CUST_SNGL_MODE_OFDM20]), OAL_FALSE},
    {"dpn2g_20m_core2_low", WLAN_CFG_DYN_POW_2G_CORE2_DPN_OFDM_20M_LOW,
     ...
     sizeof(int8_t),
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[1][WLAN_RF_CHANNEL_TWO].dpn_2g[DYN_PWR_CUST_SNGL_MODE_OFDM20]), OAL_FALSE},
    {"dpn2g_20m_core3_low", WLAN_CFG_DYN_POW_2G_CORE3_DPN_OFDM_20M_LOW,
     ...
     sizeof(int8_t),
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[1][WLAN_RF_CHANNEL_THREE].dpn_2g[DYN_PWR_CUST_SNGL_MODE_OFDM20]), OAL_FALSE},
    {"dpn2g_40m_core0_low", WLAN_CFG_DYN_POW_2G_CORE0_DPN_OFDM_40M_LOW,
     ...
     sizeof(int8_t),
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[1][WLAN_RF_CHANNEL_ZERO].dpn_2g[DYN_PWR_CUST_SNGL_MODE_OFDM40]), OAL_FALSE},
    {"dpn2g_40m_core1_low", WLAN_CFG_DYN_POW_2G_CORE1_DPN_OFDM_40M_LOW,
     ...
     sizeof(int8_t),
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[1][WLAN_RF_CHANNEL_ONE].dpn_2g[DYN_PWR_CUST_SNGL_MODE_OFDM40]), OAL_FALSE},
    {"dpn2g_40m_core2_low", WLAN_CFG_DYN_POW_2G_CORE2_DPN_OFDM_40M_LOW,
     ...
     sizeof(int8_t),
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[1][WLAN_RF_CHANNEL_TWO].dpn_2g[DYN_PWR_CUST_SNGL_MODE_OFDM40]), OAL_FALSE},
    {"dpn2g_40m_core3_low", WLAN_CFG_DYN_POW_2G_CORE3_DPN_OFDM_40M_LOW,
     ...
     sizeof(int8_t),
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[1][WLAN_RF_CHANNEL_THREE].dpn_2g[DYN_PWR_CUST_SNGL_MODE_OFDM40]), OAL_FALSE},
    {"dpn5g_20m_core0_low", WLAN_CFG_DYN_POW_5G_CORE0_DPN_20M_LOW,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[1][WLAN_RF_CHANNEL_ZERO].dpn_5g[WLAN_BW_CAP_20M]), OAL_FALSE},
    {"dpn5g_20m_core1_low", WLAN_CFG_DYN_POW_5G_CORE1_DPN_20M_LOW,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[1][WLAN_RF_CHANNEL_ONE].dpn_5g[WLAN_BW_CAP_20M]), OAL_FALSE},
    {"dpn5g_20m_core2_low", WLAN_CFG_DYN_POW_5G_CORE2_DPN_20M_LOW,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[1][WLAN_RF_CHANNEL_TWO].dpn_5g[WLAN_BW_CAP_20M]), OAL_FALSE},
    {"dpn5g_20m_core3_low", WLAN_CFG_DYN_POW_5G_CORE3_DPN_20M_LOW,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[1][WLAN_RF_CHANNEL_THREE].dpn_5g[WLAN_BW_CAP_20M]), OAL_FALSE},
    {"dpn5g_40m_core0_low", WLAN_CFG_DYN_POW_5G_CORE0_DPN_40M_LOW,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[1][WLAN_RF_CHANNEL_ZERO].dpn_5g[WLAN_BW_CAP_40M]), OAL_FALSE},
    {"dpn5g_40m_core1_low", WLAN_CFG_DYN_POW_5G_CORE1_DPN_40M_LOW,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[1][WLAN_RF_CHANNEL_ONE].dpn_5g[WLAN_BW_CAP_40M]), OAL_FALSE},
    {"dpn5g_40m_core2_low", WLAN_CFG_DYN_POW_5G_CORE2_DPN_40M_LOW,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[1][WLAN_RF_CHANNEL_TWO].dpn_5g[WLAN_BW_CAP_40M]), OAL_FALSE},
    {"dpn5g_40m_core3_low", WLAN_CFG_DYN_POW_5G_CORE3_DPN_40M_LOW,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[1][WLAN_RF_CHANNEL_THREE].dpn_5g[WLAN_BW_CAP_40M]), OAL_FALSE},
    {"dpn5g_80m_core0_low", WLAN_CFG_DYN_POW_5G_CORE0_DPN_80M_LOW,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[1][WLAN_RF_CHANNEL_ZERO].dpn_5g[WLAN_BW_CAP_80M]), OAL_FALSE},
    {"dpn5g_80m_core1_low", WLAN_CFG_DYN_POW_5G_CORE1_DPN_80M_LOW,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[1][WLAN_RF_CHANNEL_ONE].dpn_5g[WLAN_BW_CAP_80M]), OAL_FALSE},
    {"dpn5g_80m_core2_low", WLAN_CFG_DYN_POW_5G_CORE2_DPN_80M_LOW,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[1][WLAN_RF_CHANNEL_TWO].dpn_5g[WLAN_BW_CAP_80M]), OAL_FALSE},
    {"dpn5g_80m_core3_low", WLAN_CFG_DYN_POW_5G_CORE3_DPN_80M_LOW,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[1][WLAN_RF_CHANNEL_THREE].dpn_5g[WLAN_BW_CAP_80M]), OAL_FALSE},
    {"dpn5g_160m_core0_low", WLAN_CFG_DYN_POW_5G_CORE0_DPN_160M_LOW,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[1][WLAN_RF_CHANNEL_ZERO].dpn_5g[WLAN_BW_CAP_160M]), OAL_FALSE},
    {"dpn5g_160m_core1_low", WLAN_CFG_DYN_POW_5G_CORE1_DPN_160M_LOW,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[1][WLAN_RF_CHANNEL_ONE].dpn_5g[WLAN_BW_CAP_160M]), OAL_FALSE},
    {"dpn5g_160m_core2_low", WLAN_CFG_DYN_POW_5G_CORE2_DPN_160M_LOW,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[1][WLAN_RF_CHANNEL_TWO].dpn_5g[WLAN_BW_CAP_160M]), OAL_FALSE},
    {"dpn5g_160m_core3_low", WLAN_CFG_DYN_POW_5G_CORE3_DPN_160M_LOW,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[1][WLAN_RF_CHANNEL_THREE].dpn_5g[WLAN_BW_CAP_160M]), OAL_FALSE},
#ifdef _PRE_WLAN_FEATURE_6G_EXTEND
    {"dpn6g_20m_core0_low", WLAN_CFG_DYN_POW_6G_CORE0_DPN_20M_LOW,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[1][WLAN_RF_CHANNEL_ZERO].dpn_6g[WLAN_BW_CAP_20M]), OAL_FALSE},
    {"dpn6g_20m_core1_low", WLAN_CFG_DYN_POW_6G_CORE1_DPN_20M_LOW,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[1][WLAN_RF_CHANNEL_ONE].dpn_6g[WLAN_BW_CAP_20M]), OAL_FALSE},
    {"dpn6g_20m_core2_low", WLAN_CFG_DYN_POW_6G_CORE2_DPN_20M_LOW,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[1][WLAN_RF_CHANNEL_TWO].dpn_6g[WLAN_BW_CAP_20M]), OAL_FALSE},
    {"dpn6g_20m_core3_low", WLAN_CFG_DYN_POW_6G_CORE3_DPN_20M_LOW,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[1][WLAN_RF_CHANNEL_THREE].dpn_6g[WLAN_BW_CAP_20M]), OAL_FALSE},
    {"dpn6g_40m_core0_low", WLAN_CFG_DYN_POW_6G_CORE0_DPN_40M_LOW,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[1][WLAN_RF_CHANNEL_ZERO].dpn_6g[WLAN_BW_CAP_40M]), OAL_FALSE},
    {"dpn6g_40m_core1_low", WLAN_CFG_DYN_POW_6G_CORE1_DPN_40M_LOW,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[1][WLAN_RF_CHANNEL_ONE].dpn_6g[WLAN_BW_CAP_40M]), OAL_FALSE},
    {"dpn6g_40m_core2_low", WLAN_CFG_DYN_POW_6G_CORE2_DPN_40M_LOW,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[1][WLAN_RF_CHANNEL_TWO].dpn_6g[WLAN_BW_CAP_40M]), OAL_FALSE},
    {"dpn6g_40m_core3_low", WLAN_CFG_DYN_POW_6G_CORE3_DPN_40M_LOW,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[1][WLAN_RF_CHANNEL_THREE].dpn_6g[WLAN_BW_CAP_40M]), OAL_FALSE},
    {"dpn6g_80m_core0_low", WLAN_CFG_DYN_POW_6G_CORE0_DPN_80M_LOW,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[1][WLAN_RF_CHANNEL_ZERO].dpn_6g[WLAN_BW_CAP_80M]), OAL_FALSE},
    {"dpn6g_80m_core1_low", WLAN_CFG_DYN_POW_6G_CORE1_DPN_80M_LOW,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[1][WLAN_RF_CHANNEL_ONE].dpn_6g[WLAN_BW_CAP_80M]), OAL_FALSE},
    {"dpn6g_80m_core2_low", WLAN_CFG_DYN_POW_6G_CORE2_DPN_80M_LOW,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[1][WLAN_RF_CHANNEL_TWO].dpn_6g[WLAN_BW_CAP_80M]), OAL_FALSE},
    {"dpn6g_80m_core3_low", WLAN_CFG_DYN_POW_6G_CORE3_DPN_80M_LOW,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[1][WLAN_RF_CHANNEL_THREE].dpn_6g[WLAN_BW_CAP_80M]), OAL_FALSE},
    {"dpn6g_160m_core0_low", WLAN_CFG_DYN_POW_6G_CORE0_DPN_160M_LOW,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[1][WLAN_RF_CHANNEL_ZERO].dpn_6g[WLAN_BW_CAP_160M]), OAL_FALSE},
    {"dpn6g_160m_core1_low", WLAN_CFG_DYN_POW_6G_CORE1_DPN_160M_LOW,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[1][WLAN_RF_CHANNEL_ONE].dpn_6g[WLAN_BW_CAP_160M]), OAL_FALSE},
    {"dpn6g_160m_core2_low", WLAN_CFG_DYN_POW_6G_CORE2_DPN_160M_LOW,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[1][WLAN_RF_CHANNEL_TWO].dpn_6g[WLAN_BW_CAP_160M]), OAL_FALSE},
    {"dpn6g_160m_core3_low", WLAN_CFG_DYN_POW_6G_CORE3_DPN_160M_LOW,
     ...
     ARRAY_SIZE(g_cust_dyn_pow.dpn_para[1][WLAN_RF_CHANNEL_THREE].dpn_6g[WLAN_BW_CAP_160M]), OAL_FALSE},
#endif
...
static wlan_cust_cfg_cmd g_wifi_cfg_pow[] = {
    ...
    {"nvram_2g_delt_max_base_txpwr_2", NVRAM_PARA_2G_DELT_BASE_POWER_23_2,
     ...
     ARRAY_SIZE(g_cust_pow.delt_txpwr_base_params_2[WLAN_CALI_BAND_2G]), OAL_FALSE},
    {"nvram_2g_delt_max_base_txpwr_3", NVRAM_PARA_2G_DELT_BASE_POWER_23_3,
     ...
     ARRAY_SIZE(g_cust_pow.delt_txpwr_base_params_3[WLAN_CALI_BAND_2G]), OAL_FALSE},
    {"nvram_2g_delt_max_base_txpwr_4", NVRAM_PARA_2G_DELT_BASE_POWER_23_4,
     ...
     ARRAY_SIZE(g_cust_pow.delt_txpwr_base_params_4[WLAN_CALI_BAND_2G]), OAL_FALSE},
    {"nvram_5g_delt_max_base_txpwr_2", NVRAM_PARA_5G_DELT_BASE_POWER_23_2,
     ...
     ARRAY_SIZE(g_cust_pow.delt_txpwr_base_params_2[WLAN_CALI_BAND_5G]), OAL_FALSE},
    {"nvram_5g_delt_max_base_txpwr_3", NVRAM_PARA_5G_DELT_BASE_POWER_23_3,
     ...
     ARRAY_SIZE(g_cust_pow.delt_txpwr_base_params_3[WLAN_CALI_BAND_5G]), OAL_FALSE},
    {"nvram_5g_delt_max_base_txpwr_4", NVRAM_PARA_5G_DELT_BASE_POWER_23_4,
     ...
     ARRAY_SIZE(g_cust_pow.delt_txpwr_base_params_4[WLAN_CALI_BAND_5G]), OAL_FALSE},
#ifdef _PRE_WLAN_FEATURE_6G_EXTEND
    {"nvram_6g_delt_max_base_txpwr_2", NVRAM_PARA_6G_DELT_BASE_POWER_23_2,
     ...
     ARRAY_SIZE(g_cust_pow.delt_txpwr_base_params_2[WLAN_CALI_BAND_6G]), OAL_FALSE},
    {"nvram_6g_delt_max_base_txpwr_3", NVRAM_PARA_6G_DELT_BASE_POWER_23_3,
     ...
     ARRAY_SIZE(g_cust_pow.delt_txpwr_base_params_3[WLAN_CALI_BAND_6G]), OAL_FALSE},
    {"nvram_6g_delt_max_base_txpwr_4", NVRAM_PARA_6G_DELT_BASE_POWER_23_4,
     ...
     ARRAY_SIZE(g_cust_pow.delt_txpwr_base_params_4[WLAN_CALI_BAND_6G]), OAL_FALSE},
#endif
...
static wlan_cust_cfg_cmd g_wifi_cfg_cap[] = {
    ...
    {"fem_backoff_pow", WLAN_CFG_CAP_FEM_DELT_POW, g_cust_cap.fem_pow.fem_delt_pow,
     sizeof(g_cust_cap.fem_pow.fem_delt_pow[0]), ARRAY_SIZE(g_cust_cap.fem_pow.fem_delt_pow), OAL_FALSE},
    {"tpc_adj_pow_start_idx_by_fem", WLAN_CFG_CAP_FEM_ADJ_TPC_TBL_START_IDX, g_cust_cap.fem_pow.tpc_adj_pow_start_idx,
     ...
     ARRAY_SIZE(g_cust_cap.fem_pow.tpc_adj_pow_start_idx), OAL_FALSE},
    ...
    {"fb_gain_delta_pow", WLAN_CFG_CAP_FB_GAIN_DELTA_POW, &g_cust_cap.fb_gain_delta_pow[0],
     sizeof(g_cust_cap.fb_gain_delta_pow[0]), ARRAY_SIZE(g_cust_cap.fb_gain_delta_pow), OAL_FALSE},
    {"dpd_en_start_mcs", WLAN_CFG_CAP_CALI_DPD_EN_START_MCS, &g_cust_cap.dpd_en_start_mcs[0],
     sizeof(g_cust_cap.dpd_en_start_mcs[0]), ARRAY_SIZE(g_cust_cap.dpd_en_start_mcs), OAL_FALSE},
...
int32_t hwifi_shenkuo_uint_val_check(wlan_cust_range_stru *cust_check, uint8_t data_type)
{
    uint32_t val = 0;
    uint32_t read_val;
    ...
    if (memcpy_s(&val, len, addr, len) != EOK) {
        oam_error_log0(0, OAM_SF_ANY, "{hwifi_shenkuo_uint_val_check:: memory copy fail!}");
        return OAL_FAIL;
    }
    read_val = val;
    ...
    switch (cust_check->check_type) {
        ...
        case CUST_CHECK_VAL:
            ...
            break;
        default:
            oam_error_log3(0, OAM_SF_ANY, "{hwifi_shenkuo_uint_val_check:: check type[%d] max %d min %d not support!}",
    ...
    if (read_val != val) {
        oam_error_log4(0, OAM_SF_ANY, "{hwifi_shenkuo_uint_val_check::read_val[%x] val [%x] max val[%x] min val [%x]!}",
...
int32_t hwifi_shenkuo_int_val_check(wlan_cust_range_stru *cust_check, uint8_t data_type)
{
    int32_t val;
    int32_t read_val;
    ...
    switch (cust_check->check_type) {
        ...
        case CUST_CHECK_VAL:
            ...
            break;
        default:
            oam_error_log3(0, OAM_SF_ANY, "{hwifi_shenkuo_int_val_check:: check type[%d] max %d min %d not support!}",
                cust_check->check_type, cust_check->max_val, cust_check->min_val);
            break;
    }

    if (memcpy_s(addr, len, (uint8_t *)&val, len) != EOK) {
        oam_error_log0(0, OAM_SF_ANY, "{hwifi_shenkuo_int_val_check::memory copy fail!}");
        return OAL_FAIL;
    }
    if (read_val != val) {
        oam_error_log4(0, OAM_SF_ANY, "{hwifi_shenkuo_int_val_check::read_val[%d] val [%d] max val[%d] min val [%d]!}",
            read_val, val, max_val, min_val);
        return OAL_FAIL;
    }
    return OAL_SUCC;
...
static void hwifi_shenkuo_cust_val_tbl_check(wlan_cust_range_stru *range_tbl, uint32_t len)
{
    uint32_t data_idx;
    ...
    for (data_idx = 0; data_idx < len; data_idx++) {
        switch (range_tbl[data_idx].data_type) {
            ...
            case CUST_CFG_INT16:
            case CUST_CFG_INT32:
                ret = hwifi_shenkuo_int_val_check(&range_tbl[data_idx], range_tbl[data_idx].data_type);
                break;

            case CUST_CFG_UINT8:
            case CUST_CFG_UINT16:
            case CUST_CFG_UINT32:
                ret = hwifi_shenkuo_uint_val_check(&range_tbl[data_idx], range_tbl[data_idx].data_type);
                break;

            default:
                oam_error_log4(0, OAM_SF_ANY,
                    "{hwifi_shenkuo_cust_val_tbl_check::data idx[%d] check type[%d] max %d min %d not support!}",
                    data_idx, range_tbl[data_idx].check_type, range_tbl[data_idx].max_val,
                    range_tbl[data_idx].min_val);
                break;
        }
        if (ret != OAL_SUCC) {
            oam_error_log1(0, OAM_SF_ANY, "{hwifi_shenkuo_cust_val_tbl_check::data idx[%d] set invalid value!}",
                data_idx);
        }
    }
}
...
STATIC wlan_cust_range_stru g_host_cfg_range[] = {
    ...
    {&g_wlan_cust.ampdu_tx_max_num, CUST_CFG_UINT32, CUST_CHECK_VAL,
        WLAN_AMPDU_TX_MAX_NUM_SHENKUO, 1, WLAN_AMPDU_TX_MAX_NUM_SHENKUO},
...
static void hwifi_host_cust_check_shenkuo(void)
{
    hwifi_shenkuo_cust_val_tbl_check(g_host_cfg_range, ARRAY_SIZE(g_host_cfg_range));
}
void hwifi_cust_rf_rssi_check_shenkuo(void)
{
    uint8_t chan_idx;
    uint8_t rf_idx;
...
void hwifi_cust_rf_check_shenkuo(void)
{
    uint8_t chan_idx;
    uint8_t rf_idx;
    ...
    hwifi_cust_rf_rssi_check_shenkuo();
}
...
void hwifi_cust_pow_check_shenkuo(void)
{
...
{
    /* SDIO 只支持device tx/device ring tx和device rx */
...
static void hwifi_cust_4k_check(void)
{
    ...
    if (hi110x_cmu_is_tcxo_dll() != TCXO_FREQ_DET_76P8M) {
...
void hwifi_cust_cap_check_shenkuo(void)
{
    ...
    hwifi_shenkuo_cust_val_tbl_check(g_cap_cfg_range, ARRAY_SIZE(g_cap_cfg_range));
}
static void hwifi_shenkuo_cust_dyn_pow_dpn_check(uint8_t rf_idx)
{
    uint8_t band_idx;
    uint8_t mode_idx;
    uint8_t lvl_idx;
...
void hwifi_cust_dyn_pow_check_shenkuo(void)
{
    uint8_t rf_idx;
    for (rf_idx = 0; rf_idx < HD_EVENT_RF_NUM; rf_idx++) {
        hwifi_shenkuo_cust_dyn_pow_dpn_check(rf_idx);
    }
}

static void hwifi_check_custom_param_shenkuo(int32_t cus_tag)
{
    switch (cus_tag) {
        case CUS_TAG_HOST:
            hwifi_host_cust_check_shenkuo();
            break;
        case CUS_TAG_POW:
            hwifi_cust_pow_check_shenkuo();
            break;
        case CUS_TAG_RF:
            hwifi_cust_rf_check_shenkuo();
            break;
        case CUS_TAG_DYN_POW:
            hwifi_cust_dyn_pow_check_shenkuo();
            break;
        case CUS_TAG_CAP:
            hwifi_cust_cap_check_shenkuo();
            break;
        default:
            oam_error_log1(0, OAM_SF_CUSTOM, "hwifi_config_init_etc tag number[0x%x] not correct!", cus_tag);
    }
...
static void hwifi_config_init_fcc_ce_txpwr_cmd(uint8_t rf_idx)
{
    ...
    for (cfg_id = ce_start_id[rf_idx]; cfg_id < ce_end_id[rf_idx]; cfg_id++) {
        g_wifi_cfg_pow[cfg_id].data_addr = NULL;
        g_wifi_cfg_pow[cfg_id].data_type = 0;
        g_wifi_cfg_pow[cfg_id].data_num = 0;
    }
...
static void hwifi_config_init_6g_sar_ctrl_cmd(uint8_t rf_idx)
{
    ...
    for (cfg_id = start_idx; cfg_id < end_idx; cfg_id++) {
        ...
        g_wifi_cfg_pow[cfg_id].data_num =
            (uint8_t)ARRAY_SIZE(g_cust_pow.sar_ctrl_params[cfg_id - start_idx].sar_ctrl_6g_params[rf_idx]);
    }
}
#endif
/*
...
static void hwifi_config_init_sar_ctrl_cmd(uint8_t rf_idx)
{
    ...
    for (cfg_id = start_idx; cfg_id < end_idx; cfg_id++) {
        ...
        g_wifi_cfg_pow[cfg_id].data_num =
            (uint8_t)ARRAY_SIZE(g_cust_pow.sar_ctrl_params[cfg_id - start_idx].sar_ctrl_params[rf_idx]);
    }
}
...
/*
 * 函 数 名  : hwifi_config_init_shenkuo
 * 功能描述  : netdev open 调用的定制化总入口
 *             读取ini文件，更新定制化结构体成员数值
 */
int32_t hwifi_config_init_shenkuo(int32_t cus_tag)
{
    int32_t cfg_id;
    ...
    /* 检查定制化项取值范围 */
    hwifi_check_custom_param_shenkuo(cus_tag);
    return INI_SUCC;
}

#define WLAN_CFG_DTS_NVRAM_END 100 /* shenkuo产测功能待适配 */
static uint8_t g_cust_nvram_info[WLAN_CFG_DTS_NVRAM_END][CUS_PARAMS_LEN_MAX] = {{0}}; /* NVRAM数组shenkuo产测功能待适配 */

static int32_t hwifi_cust_read_nvram_flag_shenkuo(void)
{
    int32_t ret;
    ...
    if (ret == INI_SUCC) {
        ...
        if (!en_get_nvram_data_flag) {
            oal_io_print("hwifi_cust_read_nvram_flag_shenkuo::get_nvram_data_flag[%d] to abandon nvram data!!\r\n",
...
static void hwifi_cust_get_nvram_params_shenkuo(uint8_t *cust_nvram_info,
 ...
 */
int32_t hwifi_cust_get_nvram_shenkuo(void)
{
    ...
    if (!(hwifi_cust_read_nvram_flag_shenkuo())) {
    ...
    if (buffer_cust_nvram_tmp == NULL) {
        oam_error_log0(0, OAM_SF_CUSTOM, "hwifi_cust_get_nvram_shenkuo::buffer_cust_nvram_tmp mem alloc fail!");
        return INI_FILE_TIMESPEC_UNRECONFIG;
    }

    params = (int32_t *)os_kzalloc_gfp(DY_CALI_PARAMS_NUM * DY_CALI_PARAMS_TIMES * sizeof(int32_t));
    if (params == NULL) {
        oam_error_log0(0, OAM_SF_CUSTOM, "hwifi_cust_get_nvram_shenkuo::params mem alloc fail!");
    ...
    if (cust_nvram_info == NULL) {
        oam_error_log0(0, OAM_SF_CUSTOM, "hwifi_cust_get_nvram_shenkuo::cust_nvram_info mem alloc fail!");
        os_mem_kfree(buffer_cust_nvram_tmp);
        os_mem_kfree(params);
        return INI_FILE_TIMESPEC_UNRECONFIG;
    }

    hwifi_cust_get_nvram_params_shenkuo(cust_nvram_info, buffer_cust_nvram_tmp, params);
...
/* 读定制化配置文件&NVRAM */
uint32_t hwifi_custom_host_read_cfg_init_shenkuo(void)
{
...
#endif
    /* 读取nvram参数是否修改 */
    l_nv_read_ret = hwifi_cust_get_nvram_shenkuo();

    /* 检查定制化文件中的产线配置是否修改 */
    ini_read_ret = ini_file_check_conf_update();
    if (ini_read_ret || l_nv_read_ret) {
        oam_warning_log2(0, OAM_SF_CFG,
            "hwifi_custom_host_read_cfg_init_shenkuo config is updated. ini_read_ret %d, nv_read_ret %d",
            ini_read_ret, l_nv_read_ret);
        hwifi_config_init_shenkuo(CUS_TAG_DYN_POW);
    }

    if (ini_read_ret == INI_FILE_TIMESPEC_UNRECONFIG) {
        oam_warning_log0(0, OAM_SF_CFG, "hwifi_custom_host_read_cfg_init_shenkuo ini file is not updated");
        return OAL_ERR_CODE_INVALID_CONFIG;
    }
    oam_warning_log0(0, OAM_SF_CFG, "hwifi_custom_host_read_cfg_init_shenkuo config is updated");

    ini_read_ret += hwifi_config_init_shenkuo(CUS_TAG_HOST);
    ini_read_ret += hwifi_config_init_shenkuo(CUS_TAG_CAP);
    ini_read_ret += hwifi_config_init_shenkuo(CUS_TAG_RF);
    ini_read_ret += hwifi_config_init_shenkuo(CUS_TAG_POW);
    if (oal_unlikely(ini_read_ret != OAL_SUCC)) {
        oal_io_print("hwifi_custom_host_read_cfg_init_shenkuo NV fail l_ret[%d].\r\n", ini_read_ret);
    }
    return OAL_SUCC;
}

/*
 * 函 数 名  : hwifi_custom_adapt_device_init_param_shenkuo
 * 功能描述  : 配置定制化参数结束标志，下发到device触发device init流程
 */
static uint32_t hwifi_custom_adapt_device_init_param_shenkuo(uint8_t *puc_data)
{
    uint32_t data_len = 0;
    int32_t l_ret;
    ...
    if (puc_data == NULL) {
        oam_error_log0(0, OAM_SF_CFG, "{hwifi_custom_adapt_device_init_param_shenkuo::puc_data is NULL.}");
        return INI_FAILED;
    }
    /*
     * 发送消息的格式如下:
    ...
    if (l_ret != EOK) {
        oam_error_log2(0, OAM_SF_CFG, "{hwifi_custom_adapt_device_init_param_shenkuo::memcpy_s fail[%d]. data_len[%u]}",
                       l_ret, data_len);
    }
...
static void hwifi_custom_adapt_hcc_flowctrl_type_shenkuo(uint8_t *priv_cfg_value)
{
    if (hcc_bus_flowctrl_init(*priv_cfg_value) != OAL_SUCC) {
        /* GPIO流控中断注册失败，强制device使用SDIO流控(type = 0) */
        *priv_cfg_value = 0;
    }
    oal_io_print("hwifi_custom_adapt_hcc_flowctrl_type_shenkuo::sdio_flow_ctl_type[0x%x].\r\n",
                 *priv_cfg_value);
}
/*
 ...
 * 功能描述  : host校准数据内存初始化
 */
void hwifi_rf_cali_data_host_addr_init_shenkuo(void)
{
...
static uint32_t hwifi_hcc_custom_get_data_shenkuo(uint16_t syn_id, oal_netbuf_stru *netbuf)
{
    uint32_t data_len = 0;
    int32_t ret = EOK;
    ...
    switch (syn_id) {
        case CUSTOM_CFGID_INI_ID:
            /* 填充device初始化参数 */
            data_len = hwifi_custom_adapt_device_init_param_shenkuo(netbuf_data);
            break;
        case CUSTOM_CFGID_CAP_ID:
            ...
            if (hwifi_get_cust_read_status(CUS_TAG_CAP, WLAN_CFG_CAP_HCC_FLOWCTRL_TYPE)) {
                ...
                hwifi_custom_adapt_hcc_flowctrl_type_shenkuo(&g_cust_cap.hcc_flowctrl_type);
            }
            data_len = sizeof(g_cust_cap);
            ret = memcpy_s(netbuf_data, WLAN_LARGE_NETBUF_SIZE, (uint8_t *)(&g_cust_cap), data_len);
            break;
        default:
            oam_error_log1(0, OAM_SF_CFG, "hwifi_hcc_custom_get_data_shenkuo::unknown us_syn_id[%d]", syn_id);
            break;
    }

    if (ret != EOK) {
        oam_error_log3(0, OAM_SF_CFG,
            "{hwifi_hcc_custom_get_data_shenkuo::memcpy_s fail[%d] syn_id[%u] data_len[%u]}", ret, syn_id, data_len);
    }
    return data_len;
}

/*
 * 函 数 名  : hwifi_hcc_custom_ini_data_buf_shenkuo
 * 功能描述  : 下发定制化配置命令
 */
static int32_t hwifi_hcc_custom_ini_data_buf_shenkuo(uint16_t us_syn_id)
{
    ...
    if (hcc == NULL) {
        oam_error_log0(0, OAM_SF_CFG, "hwifi_hcc_custom_ini_data_buf_shenkuo hcc::is is null");
        return -OAL_EFAIL;
    }
    ...
    /* 组netbuf */
    data_len = (uint32_t)hwifi_hcc_custom_get_data_shenkuo(us_syn_id, pst_netbuf);
    if (data_len > max_data_len) {
        oam_error_log2(0, OAM_SF_CFG, "hwifi_hcc_custom_ini_data_buf_shenkuo::got wrong data_len[%d] max_len[%d]",
    ...
    if (data_len == 0) {
        oam_error_log1(0, OAM_SF_CFG, "hwifi_hcc_custom_ini_data_buf_shenkuo::data is null us_syn_id[%d]", us_syn_id);
        oal_netbuf_free(pst_netbuf);
        return OAL_SUCC;
    }
    ...
    if (oal_unlikely(l_ret != OAL_SUCC)) {
        oam_error_log2(0, OAM_SF_CFG, "hwifi_hcc_custom_ini_data_buf_shenkuo fail ret[%d]pst_netbuf[0x%lx]",
...
uint32_t hwifi_hcc_customize_h2d_data_cfg_shenkuo(void)
{
    int32_t l_ret;

    /* wifi上电时重读定制化配置 */
    if ((hwifi_custom_host_read_cfg_init_shenkuo()) != OAL_SUCC) {
        oam_warning_log0(0, OAM_SF_CFG, "hwifi_hcc_customize_h2d_data_cfg_shenkuo data ret[%d]");
    }

    /* 下发功能相关定制化 */
    l_ret = hwifi_hcc_custom_ini_data_buf_shenkuo(CUSTOM_CFGID_CAP_ID);
    if (oal_unlikely(l_ret != OAL_SUCC)) {
        oam_error_log1(0, OAM_SF_CFG, "hwifi_hcc_customize_h2d_data_cfg_shenkuo cap data fail, ret[%d]", l_ret);
        return INI_FAILED;
    }
    /* 下发device init命令 */
    l_ret = hwifi_hcc_custom_ini_data_buf_shenkuo(CUSTOM_CFGID_INI_ID);
    if (oal_unlikely(l_ret != OAL_SUCC)) {
        oam_error_log1(0, OAM_SF_CFG, "hwifi_hcc_customize_h2d_data_cfg_shenkuo init device fail, ret[%d]", l_ret);
        return INI_FAILED;
    }
...
uint32_t hwifi_config_init_nvram_main_shenkuo(oal_net_device_stru *pst_cfg_net_dev)
{
    hwifi_cust_nv_pow_data_send(pst_cfg_net_dev);
    return OAL_SUCC;
}
uint32_t hwifi_config_init_fcc_ce_params_shenkuo(oal_net_device_stru *pst_cfg_net_dev)
{
    hwifi_cust_nv_fcc_ce_pow_data_send(pst_cfg_net_dev);
    return OAL_SUCC;
}

static void hwifi_config_init_ini_main_shenkuo(oal_net_device_stru *cfg_net_dev)
{
...
void wal_send_cali_data_shenkuo(oal_net_device_stru *cfg_net_dev)
{
    ...
    hmac_send_cali_data_shenkuo(oal_net_dev_priv(cfg_net_dev), &h2d_scan_cali_trans);
    h2d_comm_cali_trans.cali_data_type = WLAN_CALI_CTL;
    hmac_send_cali_data_shenkuo(oal_net_dev_priv(cfg_net_dev), &h2d_comm_cali_trans);
}

uint32_t wal_custom_cali_shenkuo(void)
{
    ...
    hwifi_config_init_ini_main_shenkuo(net_dev);
#if (_PRE_OS_VERSION_LINUX == _PRE_OS_VERSION)
    /* 校准数据下发 */
    ...
    if (ret != OAL_SUCC) {
        oam_error_log0(0, OAM_SF_ANY, "{wal_custom_cali_shenkuo:init_dts_main fail!}");
    }
#if (_PRE_OS_VERSION_LINUX == _PRE_OS_VERSION)
    g_custom_cali_cnt++;
#endif
...
static void hwifi_config_bypass_extlna_ini_param_shenkuo(void)
{
...
static void hwifi_config_host_global_ini_param_extend_shenkuo(void)
{
#ifdef _PRE_WLAN_FEATURE_MBO
    ...
    if (g_wlan_spec_cfg->feature_11ax_is_open) {
        if (memcpy_s(&g_st_default_hiex_cap, sizeof(mac_hiex_cap_stru), &g_cust_cap.hiex_cap,
            ...
            oam_error_log0(0, OAM_SF_ANY, "hwifi_config_host_global_ini_param_extend_shenkuo::hiex cap memcpy fail!");
        }
    }
#endif
...
static void hwifi_config_dmac_freq_ini_param_shenkuo(void)
{
...
static void hwifi_config_host_amsdu_th_ini_param_shenkuo(void)
{
...
static void hwifi_config_performance_ini_param_shenkuo(void)
{
...
#ifdef _PRE_WLAN_FEATURE_MULTI_NETBUF_AMSDU
    hwifi_config_host_amsdu_th_ini_param_shenkuo();
#endif
#ifdef _PRE_WLAN_TCP_OPT
...
static void hwifi_config_tcp_ack_buf_ini_param_shenkuo(void)
{
    ...
    tcp_ack_buf_switch->us_tcp_ack_buf_throughput_low_160M = g_cust_host.tcp_ack_buf.throughput_low_160m;
...
static void hwifi_set_voe_custom_param_shenkuo(void)
{
...
void hwifi_config_host_global_11ax_ini_param_shenkuo(void)
{
...
#endif
oal_io_print("hwifi_config_host_global_11ax_ini_param_shenkuo en[%d],rom cap[%d]\r\n",
    g_pst_mac_device_capability[0].en_11ax_switch, g_st_mac_device_custom_cfg.st_11ax_custom_cfg.bit_rom_cap_switch);
}


void hwifi_config_host_global_ini_param_shenkuo(void)
{
    ...
    hwifi_config_tcp_ack_buf_ini_param_shenkuo();

    hwifi_config_dmac_freq_ini_param_shenkuo();

    hwifi_config_bypass_extlna_ini_param_shenkuo();
    ...
    hwifi_config_performance_ini_param_shenkuo();

    hwifi_config_host_global_ini_param_extend_shenkuo();

    hwifi_set_voe_custom_param_shenkuo();
#ifdef _PRE_WLAN_FEATURE_11AX
    if (g_wlan_spec_cfg->feature_11ax_is_open) {
        hwifi_config_host_global_11ax_ini_param_shenkuo();
    }
#endif
    return;
}
...
void hwifi_config_cpu_freq_ini_param_shenkuo(void)
{
    ...
    oal_io_print("hwifi_config_cpu_freq_ini_param_shenkuo irq affinity enable[%d]High_th[%u]Low_th[%u]\r\n",
...
void hwifi_show_customize_info_shenkuo(void)
{
    oal_io_print("\nhwifi_show_customize_info_shenkuo\n");
...
uint32_t hwifi_get_sar_ctrl_params_shenkuo(uint8_t lvl_num, uint8_t *data_addr,
    ...
    *data_len = sizeof(wlan_cust_sar_cfg_stru);
    if ((lvl_num <= CUS_NUM_OF_SAR_LVL) && (lvl_num > 0)) {
        ...
        if (EOK != memcpy_s(data_addr, dest_len, &g_cust_pow.sar_ctrl_params[lvl_num], *data_len)) {
            oam_error_log0(0, OAM_SF_CFG, "hwifi_get_sar_ctrl_params_shenkuo::memcpy fail!");
            return OAL_FAIL;
        }
    } else {
