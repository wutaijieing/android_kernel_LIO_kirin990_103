...
static uint32_t wal_config_reassoc_req(mac_vap_stru *mac_vap, uint32_t *param)
{
...
host_cmd_stru g_host_cmd_table[] = {
    ...
    /* 设置固定LP模式: sh hipriv.sh 'wlan0 lp_fixed_mode xx(bit0:开关 bit1-2:固定模式值(0:normal; 1:listen; 2:beacon)) */
    { "lp_fixed_mode", 1, NULL, NULL, hmac_package_uint8_params, OAL_TRUE, WLAN_CFGID_SET_LP_FIXED_MODE },
