...
void wal_netdev_open_get_fem_pa_status(oal_net_device_stru *pst_net_dev)
{
...
int32_t wal_netdev_open_wake_queues(oal_net_device_stru *pst_net_dev)
{
...
OAL_STATIC int32_t _wal_netdev_open(oal_net_device_stru *pst_net_dev, uint8_t uc_entry_flag, int32_t pm_ret)
{
    ...
    if (wal_netdev_open_wake_queues(pst_net_dev) == OAL_SUCC) {
        return OAL_SUCC;
    }
    ...
    wal_netdev_open_get_fem_pa_status(pst_net_dev);
