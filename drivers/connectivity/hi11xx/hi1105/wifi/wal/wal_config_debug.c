...
#ifdef _PRE_WLAN_FEATURE_VSP
OAL_STATIC uint32_t  wal_config_set_vsp_param(mac_vap_stru *mac_vap, uint16_t len, uint8_t *param)
{
    return hmac_vsp_process_cmd(mac_vap, len, param);
}
#endif
...
#endif
#ifdef _PRE_WLAN_FEATURE_VSP
    { WLAN_CFGID_VSP_DEBUG, OAL_FALSE, { 0 }, NULL, wal_config_set_vsp_param },
#endif
