...
static ssi_reg_info g_hi1103_ssi_master_reg_full = { 0x38, 0x28, SSI_RW_SSI_MOD };
...
int ssi_check_tcxo_available(void)
{
    ...
    ssi_read_master_regs(&g_hi1103_ssi_master_reg_full, NULL, 0, g_ssi_is_logfile);
...
int32_t ssi_tcxo_mux(uint32_t flag)
{
    ...
    if (flag == 1) {
        ...
        (void)ssi_write32(HI1103_PMU2_CMU_IR_CMU_RESERVE1_REG, 0x100);
