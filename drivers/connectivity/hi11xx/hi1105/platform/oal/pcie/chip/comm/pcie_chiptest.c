...
int32_t oal_pcie_chiptest_init_shenkuo(oal_pcie_res *pst_pci_res, int32_t device_id);
...
static pcie_chip_id_stru g_pcie_chiptest_id[] = {
    ...
    {PCIE_HISI_DEVICE_ID_SHENKUO,     oal_pcie_chiptest_init_shenkuo},
    {PCIE_HISI_DEVICE_ID_SHENKUOFPGA, oal_pcie_chiptest_init_shenkuo},
    {PCIE_HISI_DEVICE_ID_BISHENG,     oal_pcie_chiptest_init_bisheng}
};
