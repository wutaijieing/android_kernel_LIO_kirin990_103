...
int32_t oal_pcie_device_phy_config_hi1161(oal_pcie_res *pst_pci_res)
{
...
int32_t pcie_pm_chip_init_hi1161(oal_pcie_res *pst_pci_res, int32_t device_id)
{
    ...
    pst_pci_res->chip_info.cb.pm_cb.pcie_device_phy_config = oal_pcie_device_phy_config_hi1161;
    return OAL_SUCC;
}
#endif
