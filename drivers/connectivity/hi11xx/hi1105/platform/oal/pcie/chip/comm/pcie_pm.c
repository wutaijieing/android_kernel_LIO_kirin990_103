...
static pcie_chip_id_stru g_pcie_pm_chip_id[] = {
    ...
    {PCIE_HISI_DEVICE_ID_SHENKUO,     pcie_pm_chip_init_shenkuo},
    {PCIE_HISI_DEVICE_ID_SHENKUOFPGA, pcie_pm_chip_init_shenkuo},
    {PCIE_HISI_DEVICE_ID_BISHENG,    pcie_pm_chip_init_bisheng},
