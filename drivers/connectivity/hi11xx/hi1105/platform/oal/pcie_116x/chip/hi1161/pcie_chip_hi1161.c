...
/* hi1161 Registers */
#define HI1161_PA_GLB_CTL_BASE_ADDR        0x40000000
#ifdef _PRE_GT_SUPPORT
#define HI1161_PA_PCIE_DBI_BASE_ADDRESS 0x53107000
#else
#define HI1161_PA_PCIE_DBI_BASE_ADDRESS 0x40107000
#endif
...
int32_t oal_pcie_get_bar_region_info_hi1161(oal_pcie_linux_res *pcie_res, oal_pcie_region **, uint32_t *);
int32_t oal_pcie_set_outbound_membar_hi1161(oal_pcie_linux_res *pcie_res, oal_pcie_iatu_bar* pst_iatu_bar);
...
static int32_t oal_pcie_voltage_bias_init_hi1161_int(oal_pcie_linux_res *pcie_res)
{
    oal_print_hi11xx_log(HI11XX_LOG_ERR, "oal_pcie_chip_info_init_hi1161 is not implement!");
    return OAL_SUCC;
}

static int32_t oal_pcie_host_slave_address_switch_hi1161_int(oal_pcie_linux_res *pcie_res, uint64_t src_addr,
...
{
    msleep(1000);
    oal_print_hi11xx_log(HI11XX_LOG_INFO, "oal_pcie_poweroff_complete succ");
    return OAL_SUCC;
}
...
int32_t oal_pcie_chip_info_init_hi1161(oal_pcie_linux_res *pcie_res, int32_t device_id)
{
    oal_pcie_ep_res *ep_res = &pcie_res->ep_res;
    ...
    ep_res->chip_info.addr_info.dbi = HI1161_PA_PCIE_DBI_BASE_ADDRESS;
    ep_res->chip_info.addr_info.ete_ctrl = HOST_CTRL_RB_BASE;
    ep_res->chip_info.addr_info.glb_ctrl = HI1161_PA_GLB_CTL_BASE_ADDR;
    ep_res->chip_info.addr_info.pmu_ctrl = HI1161_PA_PMU_CMU_CTL_BASE;
    ep_res->chip_info.addr_info.pmu2_ctrl = HI1161_PA_PMU2_CMU_IR_BASE;
    ep_res->chip_info.addr_info.boot_version = HI1161_DEV_VERSION_CPU_ADDR;
