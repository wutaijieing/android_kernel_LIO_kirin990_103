...
typedef enum {
    ...
    OAM_FILE_ID_WAL_CFG_C = 1271,
    OAM_FILE_ID_WAL_CFG_H = 1272,
    OAM_FILE_ID_WAL_CFG_TEST_C = 1273,
    OAM_FILE_ID_WAL_CFG_TEST_H = 1274,

    /* HMAC */
    OAM_FILE_ID_HMAC_MCAST_AMPDU_C = 1291,
    OAM_FILE_ID_HMAC_MCAST_AMPDU_H = 1292,
    ...
    OAM_FILE_ID_HMAC_CONFIG_MIB_C = 1417,
    ...
    OAM_FILE_ID_HMAC_CONFIG_CHBA_C = 1431,
    ...
    /* HAL */
    OAM_FILE_ID_HOST_HAL_DSCR_SHENKUO_C = 1600,
    OAM_FILE_ID_HOST_HAL_DSCR_BISHENG_C = 1601,
    OAM_FILE_ID_HOST_HAL_MAC_SHENKUO_C = 1602,
    OAM_FILE_ID_HOST_HAL_MAC_BISHENG_C = 1603,
    OAM_FILE_ID_HOST_HAL_DSCR_C = 1604,
    OAM_FILE_ID_HOST_HAL_DSCR_H = 1605,
    OAM_FILE_ID_HOST_HAL_MAIN_SHENKUO_C = 1606,
    OAM_FILE_ID_HOST_HAL_MAIN_BISHENG_C = 1607,
    OAM_FILE_ID_HOST_HAL_IRQ_SHENKUO_C = 1608,
    OAM_FILE_ID_HOST_HAL_IRQ_BISHENG_C = 1609,
    OAM_FILE_ID_HOST_HAL_FTM_SHENKUO_C = 1610,
    OAM_FILE_ID_HOST_HAL_FTM_BISHENG_C = 1611,
    OAM_FILE_ID_HOST_HAL_DEVICE_C = 1612,
    OAM_FILE_ID_HOST_HAL_DEVICE_H = 1613,
    OAM_FILE_ID_HOST_HAL_CSI_SHENKUO_C = 1614,
    OAM_FILE_ID_HOST_HAL_CSI_BISHENG_C = 1615,
    OAM_FILE_ID_HOST_HAL_TX_SHENKUO_C = 1616,
    ...
    OAM_FILE_ID_HISI_CUSTOMIZE_CONFIG_PRIV_HI1103_C = 1685,
    OAM_FILE_ID_HISI_CUSTOMIZE_CONFIG_CMD_HI1103_C = 1686,
    OAM_FILE_ID_HISI_CUSTOMIZE_NVRAM_CONFIG_HI1103_C = 1687,
    ...
    OAM_FILE_ID_OAL_SPINLOCK_H = 1821,
    ...
    OAM_FILE_ID_PCIE_PM_HI1106_C = 2517,
    ...
    OAM_FILE_ID_HMAC_TX_DATA_MACRO_H = 2779,
    /* alg rom */
    ...
    OAM_FILE_ID_HMAC_TID_UPDATE_C = 2832,
    OAM_FILE_ID_HMAC_TID_SCHE_C = 2833,
    ...
    OAM_FILE_ID_HMAC_SNIFFER_C = 2842,
    ...
    OAM_FILE_ID_HMAC_TX_SWITCH_FSM_C = 2872,
    /* hwal */
    OAM_FILE_ID_HWAL_IOCTL_C = 2873,
    OAM_FILE_ID_HWAL_EVENT_C = 2874,
    OAM_FILE_ID_HWAL_NET_C = 2875,
    OAM_FILE_ID_HMAC_FTM_C = 2876,
    OAM_FILE_ID_HMAC_RATE_CALC_C = 2877,
    OAM_FILE_ID_HOST_SNIFFER_BISHENG_C = 2879,
    OAM_FILE_ID_HMAC_VSP_C = 2880,
    OAM_FILE_ID_HMAC_VSP_SOURCE_C = 2881,
    OAM_FILE_ID_HMAC_VSP_SINK_C = 2882,
    OAM_FILE_ID_HMAC_PPS_FSM_C = 2883,
    OAM_FILE_ID_HMAC_TX_SCHE_SWITCH_FSM_C = 2884,
    OAM_FILE_ID_HMAC_GNSS_RSMC_C = 2885,
    OAM_FILE_ID_HMAC_TID_RING_SWITCH_C = 2886,
    OAM_FILE_ID_HMAC_VSP_MAIN_C = 2887,
    /* hid2d */
    OAM_FILE_ID_WIFI_HID2D_COMMON_FUNCTION_C = 2888,
    OAM_FILE_ID_WIFI_HID2D_FRAME_C = 2889,
    OAM_FILE_ID_WIFI_HID2D_MGMT_C = 2890,
    OAM_FILE_ID_WIFI_HID2D_PS_C = 2891,
    OAM_FILE_ID_WIFI_HID2D_RRM_C = 2892,
    OAM_FILE_ID_WIFI_HID2D_RRM_ALG_C = 2893,
    OAM_FILE_ID_WIFI_HID2D_SYNC_C = 2894,
    OAM_FILE_ID_WIFI_HID2D_CHAN_SWITCH_C = 2895,
    OAM_FILE_ID_WIFI_HID2D_COEX_C = 2896,

    /* GT协议特有的业务代码 */
    OAM_FILE_ID_HMAC_TID_C = 2897,
    OAM_FILE_ID_HMAC_CFG_C = 2898,
    OAM_FILE_ID_HMAC_CFG_RSP_C = 2899,
    OAM_FILE_ID_HOST_HAL_IRQ_1161_C = 2900,
    OAM_FILE_ID_HMAC_MONITOR_C = 2901,
    OAM_FILE_ID_HMAC_CFG_RSP_TEST_C = 2902,

    OAM_FILE_ID_HMAC_VSP_TEST_C = 2903,

/* begin:CHBA */
    OAM_FILE_ID_HMAC_CHBA_COMMON_FUNCTION_C = 2904,
    OAM_FILE_ID_HMAC_CHBA_COMMON_FUNCTION_H = 2905,
    OAM_FILE_ID_HMAC_CHBA_MGMT_C = 2906,
    OAM_FILE_ID_HMAC_CHBA_MGMT_H = 2907,
    OAM_FILE_ID_HMAC_CHBA_PS_C = 2908,
    OAM_FILE_ID_HMAC_CHBA_PS_H = 2909,
    OAM_FILE_ID_HMAC_CHBA_SYNC_C = 2910,
    OAM_FILE_ID_HMAC_CHBA_SYNC_H = 2911,
    OAM_FILE_ID_HMAC_CHBA_CHAN_SWITCH_C = 2912,
    OAM_FILE_ID_HMAC_CHBA_CHAN_SWITCH_H = 2913,
    OAM_FILE_ID_HMAC_CHBA_COEX_C = 2914,
    OAM_FILE_ID_HMAC_CHBA_COEX_H = 2915,
    OAM_FILE_ID_HMAC_CHBA_USER_C = 2916,
    OAM_FILE_ID_HMAC_CHBA_USER_H = 2917,
    OAM_FILE_ID_HMAC_CHBA_FRAME_C = 2918,
    OAM_FILE_ID_HMAC_CHBA_FRAME_H = 2919,
    OAM_FILE_ID_HMAC_CHBA_INTERFACE_C = 2920,
    OAM_FILE_ID_HMAC_CHBA_INTERFACE_H = 2921,
    OAM_FILE_ID_HMAC_CHBA_FUNCTION_C = 2922,
    OAM_FILE_ID_HMAC_CHBA_FUNCTION_H = 2923,
    OAM_FILE_ID_HMAC_CHBA_FSM_C = 2924,
    OAM_FILE_ID_HMAC_WIFI_DELAY_C = 2925,
    OAM_FILE_ID_HMAC_CHBA_CHANNEL_SEQUENCE_C = 2926,

    /* end:CHBA */
    OAM_FILE_ID_HOST_PSD_C = 2932,
    OAM_FILE_ID_HMAC_CHAN_DET_C = 2933,
    OAM_FILE_ID_HMAC_VSP_SOURCE_BUF_C = 2934,

    OAM_FILE_ID_HMAC_AUDIO_HUB_C = 2939,
    OAM_FILE_ID_HMAC_AUDIO_MAIN_C = 2940,
    OAM_FILE_ID_HMAC_AUDIO_FSM_C = 2941,
    OAM_FILE_ID_HOST_HAL_TX_BISHENG_C = 2942,
    OAM_FILE_ID_HMAC_TX_RING_ALLOC_C = 2943,
    OAM_FILE_ID_HISI_CUSTOMIZE_CONFIG_DTS_HI1103_C = 2945,
    OAM_FILE_ID_MAC_VAP_INIT_C = 2946,
    OAM_FILE_ID_WLAN_CHIP_1161_C = 2947,
    OAM_FILE_ID_HISI_CUSTOMIZE_GT_HI1161_C = 2948,
    OAM_FILE_ID_HMAC_AUDIO_CMD_C = 2949,
    OAL_FILE_ID_APERF_DRV_C = 2950,
    OAM_FILE_ID_MAC_ANP_H = 2951,
    OAM_FILE_ID_APERF_DRV_ANP_C = 2952,
    OAM_FILE_ID_APERF_DRV_INTF_C = 2953,
