...
/*lint -e(413)*/((_data_type *)((int8_t *)(_list_ptr)-(uint32_t)(&((_data_type *)0)->_data_member_list_name)))
...
/*lint -e(413)*/((_data_type *)((int8_t *)(_dlist_ptr)- \
                (uint32_t)(uintptr_t)(&((_data_type *)0)->_data_member_dlist_name)))
...
{
    if (pst_head->pst_next == NULL || pst_head->pst_prev == NULL) {
        return OAL_TRUE;
    }
...
{
    if (oal_unlikely((pst_entry->pst_next == NULL) || (pst_entry->pst_prev == NULL))) {
        return;
    }
