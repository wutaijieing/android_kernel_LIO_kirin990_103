...
static inline void atomic_add_statement(unsigned long tmp, int result, int i, oal_atomic *v)
{
...
OAL_STATIC OAL_INLINE void  oal_bit_atomic_set(int32_t nr, OAL_VOLATILE oal_bitops *p_addr)
{
    UINTPTR uvIntSave;
    uvIntSave = LOS_IntLock();
...
OAL_STATIC OAL_INLINE int32_t  oal_bit_atomic_test(int32_t nr, OAL_VOLATILE oal_bitops *p_addr)
{
    return 1UL & (p_addr[BIT_WORD(nr)] >> (nr & (BITS_PER_LONG-1)));
}


OAL_STATIC OAL_INLINE oal_bitops  oal_bit_atomic_test_and_set(int32_t nr, OAL_VOLATILE oal_bitops *p_addr)
{
    UINTPTR uvIntSave;
    uvIntSave = LOS_IntLock();
...
OAL_STATIC OAL_INLINE oal_bitops  oal_bit_atomic_test_and_clear(int32_t nr, OAL_VOLATILE oal_bitops *p_addr)
{
    UINTPTR uvIntSave;
    uvIntSave = LOS_IntLock();
...
OAL_STATIC OAL_INLINE void  oal_bit_atomic_clear(int32_t nr, OAL_VOLATILE oal_bitops *p_addr)
{
    UINTPTR uvIntSave;
    uvIntSave = LOS_IntLock();
