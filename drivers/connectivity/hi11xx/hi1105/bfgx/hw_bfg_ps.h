...
#define GLE_TX_MAX_FRAME  3000  /* tx gle data max lenth */
...
#define GLE_RX_MAX_FRAME               1500  /* RX gle data max lenth */
...
#define WAIT_GLE_OPEN_TIME    3000
#define WAIT_GLE_CLOSE_TIME   3000
...
#endif
    SYS_CFG_OPEN_GLE  = 0x28,             /* host通过uart打开GLE */
    SYS_CFG_CLOSE_GLE = 0x29,             /* host通过uart打开GLE */
...
enum SYS_INF_MSG_VALUE_ENUM {
    ...
    SYS_INF_GLE_INIT = 0x25,                /* GLE软件初始化完成 */
    SYS_INF_GLE_EXIT = 0x26,                /* GLE退出 */
...
typedef enum {
    ...
    BFGX_NFC = 0x04,
    BFGX_GLE = 0x05,
    BFGX_ME  = 0x05, // shengkuo ME, bisheng GLE
    BFGX_BUTT = 0x06
...
#define HI110X_GLE_SUB_MASK   (1 << BFGX_GLE)
