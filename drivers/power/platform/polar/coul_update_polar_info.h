...
static inline int show_polar_log_head(char *buf, size_t dest_max)
{
	return -1;
}

static inline int show_polar_log_content(char *buf, size_t dest_max)
{
	return -1;
}
