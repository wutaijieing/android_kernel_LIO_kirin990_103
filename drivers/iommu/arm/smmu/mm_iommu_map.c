				...
				unsigned long iova)
{
	...
	ret = do_iommu_unmap_sg(dev, domain, iova_dom->size, iova);
				...
				unsigned long iova)
{
	...
	ret = do_iommu_unmap_sg(dev, domain, iova_size, iova);
				...
				struct iommu_domain domain)
{
	...
	ret = do_iommu_unmap_sg(NULL, cookie->domain, iova_dom->size, iova);
	if (ret)
