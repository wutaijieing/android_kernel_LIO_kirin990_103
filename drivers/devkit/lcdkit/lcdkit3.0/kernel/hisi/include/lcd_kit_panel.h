...
#define PANEL_350_507_12P6           "350_507_12p6"
...
struct lcd_kit_panel_ops {
	...
	int (*eink_power_on)(void);
	int (*eink_power_off)(void);
	void (*eink_suspend)(void);
	void (*eink_resume)(void);
	void (*eink_spi_async_time)(void);
	int (*eink_judgement_suspend)(void);
};
