...
struct lcd_kit_disp_info {
	...
	/* dc delay set */
	u32 mtk_dc_delay_enable;
	u32 mtk_dc_left_time_th_us;
	u32 mtk_dc_right_time_th_us;
	u32 mtk_dc_te_inerval_time_us;
	u32 mtk_dc_delay_time_us;
