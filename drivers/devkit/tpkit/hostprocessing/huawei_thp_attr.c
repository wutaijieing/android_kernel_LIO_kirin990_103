...
#if ((defined CONFIG_FB) && (!defined CONFIG_HUAWEI_THP_QCOM) && (!defined CONFIG_HUAWEI_THP_MTK) && (!defined CONFIG_HUAWEI_THP_UDP))
#include "hisi_fb.h"
#endif
...
static DEVICE_ATTR(daemon_version, 0440,
	thp_daemon_version_show, NULL);
