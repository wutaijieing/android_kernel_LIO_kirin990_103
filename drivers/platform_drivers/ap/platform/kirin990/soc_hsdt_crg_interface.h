...
#define SOC_HSDT_CRG_FNPLL_CFG0_divval_fnpll_1v2_START (20)
#define SOC_HSDT_CRG_FNPLL_CFG0_divval_fnpll_1v2_END (23)
#define SOC_HSDT_CRG_FNPLL_CFG0_spread_fnpll_1v2_START (24)
#define SOC_HSDT_CRG_FNPLL_CFG0_spread_fnpll_1v2_END (26)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
...
#define SOC_HSDT_CRG_FNPLL_CFG2_ctinue_lock_num_fnpll_1v2_END (12)
