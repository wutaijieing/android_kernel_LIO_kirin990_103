...
#define SOC_CRGPERIPH_PLL_UNLOCK_DETECT_INTR_BYPSS_ACPU_mpll2_unlock_intr_bypass_START (15)
#define SOC_CRGPERIPH_PLL_UNLOCK_DETECT_INTR_BYPSS_ACPU_mpll2_unlock_intr_bypass_END (15)
...
#define SOC_CRGPERIPH_PLL_UNLOCK_DETECT_INTR_BYPSS_LPM3_mpll2_unlock_intr_bypass_START (15)
#define SOC_CRGPERIPH_PLL_UNLOCK_DETECT_INTR_BYPSS_LPM3_mpll2_unlock_intr_bypass_END (15)
...
typedef union
{
    ...
    struct
    {
        ...
        unsigned int mpll2_unlock_intr_cnt : 4;
    } reg;
...
#define SOC_CRGPERIPH_PLL_UNLOCK_DETECTCNT1_mpll2_unlock_intr_cnt_START (28)
#define SOC_CRGPERIPH_PLL_UNLOCK_DETECTCNT1_mpll2_unlock_intr_cnt_END (31)
#ifndef __SOC_H_FOR_ASM__
typedef union
{
    unsigned int value;
