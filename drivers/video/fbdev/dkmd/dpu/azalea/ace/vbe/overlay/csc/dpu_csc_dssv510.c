...
static void dpu_csc_get_coef(struct dpu_fb_data_type *dpufd, struct dss_csc_info *csc_info,
	dss_layer_t *layer, dss_wb_layer_t *wb_layer)
{
	dss_csc_t *csc = NULL;
	struct dss_csc_coe csc_coe = {0};
...
int dpu_csc_config(struct dpu_fb_data_type *dpufd, dss_layer_t *layer, dss_wb_layer_t *wb_layer)
{
