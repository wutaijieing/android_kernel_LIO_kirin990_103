	...
	uint16_t *buf_map, uint32_t buf_size)
{
	int ret = 0;
	uint16_t num = 0;
	uint32_t num_of_elements = buf_size / sizeof(uint16_t);
...
int display_engine_ddic_color_param_set(struct dpu_fb_data_type *dpufd,
...
int display_engine_ddic_cabc_param_set(struct dpu_fb_data_type *dpufd,
...
int display_engine_ddic_rgbw_param_set(struct dpu_fb_data_type *dpufd,
...
int display_engine_amoled_algo_param_set(struct dpu_fb_data_type *dpufd,
	...
	struct effect_bl_buf *resolved_buf, const bool dc_enable_changed)
{
	...
	if (dpu_check_panel_product_type(dpufd->panel_info.product_type)) {
		...
		if (dpu_effect_xcc_info_set_kernel(dpufd,
