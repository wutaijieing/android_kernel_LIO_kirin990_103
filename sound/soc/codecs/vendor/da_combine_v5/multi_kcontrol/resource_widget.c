...
{
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_209, 0xBB);
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_210, 0x80);
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_203, 0x59);
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_213, 0x28);
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_205, 0x08);
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_147, 0xC8);
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_204, 0xF9);
}

static void pll48k_config(struct snd_soc_component *codec)
{
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_154, 0x11);
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_156, 0xEB);
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_157, 0x80);
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_150, 0x51);
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_152, 0x40);
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_159, 0xAC);
}
...
static void pll44k1_config(struct snd_soc_component *codec)
{
	...
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_177, 0x0E);
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_179, 0xB3);
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_180, 0x30);
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_175, 0x00);
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_182, 0x9A);
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_176, 0x81);
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_173, 0x40);
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_171, 0x0F);
...
{
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_104, 0x80); /* en GBR */
	usleep_range(10000, 11000);
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_127, 0x40); /* en fast start */
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_130, 0x04); /* cfg LDOTRX to 1.8 */
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_104, 0x84); /* en LDOTRX */
...
int pll48k_turn_on(struct snd_soc_component *codec)
{
	...
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_148, 0x2F);
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_153, 0x80);
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_150, 0x41);
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_149, 0x10);
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_148, 0x28);
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_151, 0x78);
	udelay(25);
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_149, 0xD0);
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_148, 0xA8);
...
static int pll48k_turn_off(struct snd_soc_component *codec)
{
	...
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_148, 0x2F);
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_151, 0x42);
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_150, 0x51);
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_153, 0x0);
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_149, 0x10);
...
static int pll44k1_turn_on(struct snd_soc_component *codec)
{
	...
	da_combine_update_bits(codec, AUD_CLK_EN_REG,
		...
		BIT(AUD_44P1K_SEL2_OFFSET) | BIT(AUD_44P1K_SEL0_OFFSET));
	/* pll enable */
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_172, 0x10);
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_171, 0x8);
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_174, 0x78);
	udelay(25);
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_172, 0xD0);
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_171, 0x88);
...
static int pll44k1_turn_off(struct snd_soc_component *codec)
{
	...
	select_ana_clk_source(codec, PLL_HIGH);
	/* pll disable */
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_171, 0x2F);
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_174, 0x40);
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_172, 0xD0);
...
static int pllmad_turn_on(struct snd_soc_component *codec)
{
	...
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_204, 0xF8);
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_203, 0x41);
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_147, 0xC0);
	udelay(25);
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_204, 0xF9);
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_203, 0x43);
...
int enable_supply(struct snd_soc_component *codec)
{
	...
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_146, 0x19); /* pll ibias en */
...
static int disable_supply(struct snd_soc_component *codec)
{
	...
	snd_soc_component_write_adapter(codec, CODEC_ANA_RWREG_146, 0x59); /* pll bias disable */
	...
	struct snd_kcontrol *kcontrol, int event)
{
	...
	case SND_SOC_DAPM_PRE_PMU:
		...
		if (!priv->cdc_ctrl->pm_runtime_support) {
			mdelay(2);
			ret = codec_bus_switch_framer(FRAMER_CODEC);
			if (ret)
				AUDIO_LOGE("switch framer failed");
		}
		break;
	case SND_SOC_DAPM_POST_PMD:
		if (!priv->cdc_ctrl->pm_runtime_support) {
			ret = codec_bus_switch_framer(FRAMER_SOC);
			if (ret)
				AUDIO_LOGE("switch framer to soc failed");
			mdelay(2);
		}
