...
#define S1_I2S_CFG_KCONTROLS \
	...
	SOC_SINGLE("S1_CODEC_IO_WORDLENGTH", \
		I2S1_CTRL_REG, I2S1_CODEC_IO_WORDLENGTH_OFFSET, \
		MAX_VAL_ON_BIT(I2S1_CODEC_IO_WORDLENGTH_LEN), 0) \
...
#define S3_CFG_KCONTROLS \
	...
	SOC_SINGLE("FS_S3_IF_I2S", \
		I2S3_PCM_CTRL_REG, FS_I2S3_OFFSET, \
		MAX_VAL_ON_BIT(FS_I2S3_LEN), 0), \
	SOC_SINGLE("S3_CODEC_IO_WORDLENGTH", \
		I2S3_PCM_CTRL_REG, I2S3_CODEC_IO_WORDLENGTH_OFFSET, \
		MAX_VAL_ON_BIT(I2S3_CODEC_IO_WORDLENGTH_LEN), 0) \
...
#define AU_KCONTROLS \
	SOC_SINGLE("AU_DIRECT_LOOP", \
		AU_CTRL_REG, AU_S2P_LOOP_OFFSET, \
		MAX_VAL_ON_BIT(AU_S2P_LOOP_LEN), 0) \
