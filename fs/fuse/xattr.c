		  ...
		  size_t size, int flags)
{
	...
	if ((is_user && fm->fc->no_setxattr_user) ||
	    (!is_user && fm->fc->no_setxattr))
		return -EOPNOTSUPP;
		      ...
		      size_t size)
{
	...
	if ((is_user && fm->fc->no_getxattr_user) ||
	    (!is_user && fm->fc->no_getxattr))
		return -EOPNOTSUPP;
...
int fuse_removexattr(struct inode *inode, const char *name)
{
	...
	if ((is_user && fm->fc->no_removexattr_user) ||
	    (!is_user && fm->fc->no_removexattr))
		return -EOPNOTSUPP;
