...
#define HISYSEVENT_FORMAT_STRING_INDEX 4
#define HISYSEVENT_FIRST_PARAM_INDEX 5

enum HiSySEventType {
	/* system fault event */
	FAULT     = 1,
	/* system statistic event */
	STATISTIC = 2,
...
int hiview_send_hisysevent(const char* domain, const char* event_name, enum HiSySEventType type, const char *fmt, ...)
				__attribute__((__format__(__printf__, HISYSEVENT_FORMAT_STRING_INDEX, HISYSEVENT_FIRST_PARAM_INDEX)));
