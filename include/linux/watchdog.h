...
#else
static inline void watchdog_lockup_panic_config(unsigned int enable)
{
	return;
}

static inline bool watchdog_softlockup_happen(void)
{
	return false;
}

static inline bool watchdog_othercpu_hardlockup_happen(void)
{
	return false;
}

static inline bool watchdog_hiwdt_hardlockup_happen(void)
{
	return false;
}

static inline void watchdog_set_thresh(int timeout)
{
	return;
}

static inline void watchdog_check_hardlockup_hiwdt(void)
{
	return;
}

static inline void watchdog_shutdown_oneshot(unsigned int timeout)
{
	return;
}
#endif
