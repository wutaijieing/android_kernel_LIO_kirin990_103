...
#define stat_inc_mmap_asyncread_pages_count(cnt)	\
	(atomic64_add(cnt, &(pagecache_info)->stat->mmap_asyncread_pages_count))
...
static inline void pgcache_log(u32 ctrl  __attribute__((unused)),
	const char *fmt __attribute__((unused)), ...)
{ }
static inline void pgcache_log_path(u32 ctrl __attribute__((unused)),
	const struct path *path __attribute__((unused)),
	const char *fmt __attribute__((unused)), ...)
{ }
static inline void pgcache_log_dentry(u32 ctrl __attribute__((unused)),
	const struct dentry *dentry __attribute__((unused)),
	const char *fmt __attribute__((unused)), ...)
{ }
#endif
