...
#include "../../../platform_source/basicplatform/drivers/mntn/blackbox/rdr_inner.h"
...
#define DFX_MEM_ALLOC 1
#define DFX_MEM_FREE  0
...
int percpu_buffer_init(struct percpu_buffer_info *buffer_info, u32 ratio[][DFX_HOOK_CPU_NUMBERS],
