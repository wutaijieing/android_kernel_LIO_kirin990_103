...
static const struct partition partition_table_emmc[] = {
    ...
    {PART_RESERVED8,             230 * 1024,          4 * 1024,    EMMC_USER_PART}, /* RESERVED8          4M    p15 */
    ...
    {PART_RESERVED7,             513 * 1024,          2 * 1024,    EMMC_USER_PART}, /* RESERVED7          2M    p33 */
    {PART_IVP,                   515 * 1024,          2 * 1024,    EMMC_USER_PART}, /* ivp                2M    p34 */
    {PART_HDCP,                  517 * 1024,          1 * 1024,    EMMC_USER_PART}, /* PART_HDCP          1M    p35 */
    {PART_RESERVED9,             518 * 1024,          4 * 1024,    EMMC_USER_PART}, /* RESERVED9          4M    p36 */
    {PART_HHEE,                  522 * 1024,          4 * 1024,    EMMC_USER_PART}, /* hhee               4M    p37 */
    {PART_RESERVED10,            526 * 1024,          8 * 1024,    EMMC_USER_PART}, /* RESERVED10         8M    p38 */
    ...
    {PART_RESERVED5,           15256 * 1024,       2048 * 1024,    EMMC_USER_PART}, /* RESERVED5       2048M    p87 */
    ...
    {PART_RESERVED5,           10744 * 1024,       2048 * 1024,    EMMC_USER_PART}, /* RESERVED5       2048M    p82 */
    ...
    {PART_VERSION,             12064 * 1024,        576 * 1024,    EMMC_USER_PART}, /* version          576M    p80 */
    {PART_PRELOAD,             12640 * 1024,       1400 * 1024,    EMMC_USER_PART}, /* preload         1400M    p81 */
    {PART_RESERVED5,           14040 * 1024,       2048 * 1024,    EMMC_USER_PART}, /* RESERVED5       2048M    p82 */
    ...
    {PART_RESERVED5,           15120 * 1024,       2048 * 1024,    EMMC_USER_PART}, /* RESERVED5       2048M    p82 */
    ...
    {PART_RESERVED5,           11664 * 1024,       2048 * 1024,    EMMC_USER_PART}, /* RESERVED5       2048M    p82 */
    ...
    {PART_RESERVED5,           14960 * 1024,       2048 * 1024,    EMMC_USER_PART}, /* RESERVED5       2048M    p82 */
...
static const struct partition partition_table_ufs[] = {
    ...
    {PART_RESERVED8,             222 * 1024,          4 * 1024,    UFS_PART_3}, /* RESERVED8          4M    p11 */
    ...
    {PART_RESERVED7,             505 * 1024,          2 * 1024,    UFS_PART_3}, /* RESERVED7          2M    p29 */
    {PART_IVP,                   507 * 1024,          2 * 1024,    UFS_PART_3}, /* ivp                2M    p30 */
    {PART_HDCP,                  509 * 1024,          1 * 1024,    UFS_PART_3}, /* PART_HDCP          1M    p31 */
    {PART_RESERVED9,             510 * 1024,          4 * 1024,    UFS_PART_3}, /* RESERVED9          4M    p32 */
    {PART_HHEE,                  514 * 1024,          4 * 1024,    UFS_PART_3}, /* hhee               4M    p33 */
    {PART_RESERVED10,            518 * 1024,          8 * 1024,    UFS_PART_3}, /* RESERVED10         8M    p34 */
    ...
    {PART_RESERVED5,           15248 * 1024,       2048 * 1024,    UFS_PART_3}, /* RESERVED5       2048M    p83 */
    ...
    {PART_RESERVED5,           10736 * 1024,       2048 * 1024,    UFS_PART_3}, /* RESERVED5       2048M    p78 */
    ...
    {PART_VERSION,             12056 * 1024,        576 * 1024,    UFS_PART_3}, /* version          576M    p76 */
    {PART_PRELOAD,             12632 * 1024,       1400 * 1024,    UFS_PART_3}, /* preload         1400M    p77 */
    {PART_RESERVED5,           14032 * 1024,       2048 * 1024,    UFS_PART_3}, /* RESERVED5       2048M    p78 */
    ...
    {PART_RESERVED5,           15112 * 1024,       2048 * 1024,    UFS_PART_3}, /* RESERVED5       2048M    p78 */
    ...
    {PART_RESERVED5,           11656 * 1024,       2048 * 1024,    UFS_PART_3}, /* RESERVED5       2048M    p78 */
    ...
    {PART_RESERVED5,           14952 * 1024,       2048 * 1024,    UFS_PART_3}, /* RESERVED5       2048M    p78 */
