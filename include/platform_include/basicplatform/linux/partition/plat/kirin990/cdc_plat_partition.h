...
static const struct partition partition_table_emmc[] = {
    ...
    {PART_BOOT,                      630 * 1024,   30 * 1024,    EMMC_USER_PART}, /* boot              30M    p46 */
    {PART_RECOVERY,                  660 * 1024,   41 * 1024,    EMMC_USER_PART}, /* recovery          41M    p47 */
    {PART_ERECOVERY,                 701 * 1024,   41 * 1024,    EMMC_USER_PART}, /* erecovery         41M    p48 */
    {PART_METADATA,                  742 * 1024,   16 * 1024,    EMMC_USER_PART}, /* metadata          16M    p49 */
    {PART_KPATCH,                    758 * 1024,   43 * 1024,    EMMC_USER_PART}, /* reserved          43M    p50 */
#else
    {PART_ERECOVERY_RAMDISK,         574 * 1024,   32 * 1024,    EMMC_USER_PART}, /* erecovery_ramdisk 32M    p44 */
    {PART_ERECOVERY_VENDOR,          606 * 1024,   16 * 1024,    EMMC_USER_PART}, /* erecovery_vendor  16M    p45 */
    {PART_BOOT,                      622 * 1024,   30 * 1024,    EMMC_USER_PART}, /* boot              30M    p46 */
    {PART_RECOVERY,                  652 * 1024,   45 * 1024,    EMMC_USER_PART}, /* recovery          45M    p47 */
    {PART_ERECOVERY,                 697 * 1024,   45 * 1024,    EMMC_USER_PART}, /* erecovery         45M    p48 */
    {PART_METADATA,                  742 * 1024,   16 * 1024,    EMMC_USER_PART}, /* metadata          16M    p49 */
    {PART_KPATCH,                    758 * 1024,   43 * 1024,    EMMC_USER_PART}, /* reserved          43M    p50 */
#endif
...
static struct partition partition_table_ufs[] = {
    ...
    {PART_BOOT_A,                  622 * 1024,     30 * 1024,    UFS_PART_3}, /* boot_a              30M    p56 */
    {PART_RECOVERY_A,              652 * 1024,     41 * 1024,    UFS_PART_3}, /* recovery_a          41M    p57 */
    {PART_ERECOVERY_A,             693 * 1024,     41 * 1024,    UFS_PART_3}, /* erecovery_a         41M    p58 */
    {PART_METADATA,                734 * 1024,     16 * 1024,    UFS_PART_3}, /* metadata            16M    p59 */
    {PART_KPATCH_A,                750 * 1024,     43 * 1024,    UFS_PART_3}, /* kpatch_a            43M    p60 */
    ...
    {PART_BOOT_B,                  849 * 1024,     30 * 1024,    UFS_PART_3}, /* boot_b              30M    p63 */
    {PART_RECOVERY_B,              879 * 1024,     41 * 1024,    UFS_PART_3}, /* recovery_b          41M    p64 */
    {PART_ERECOVERY_B,             920 * 1024,     41 * 1024,    UFS_PART_3}, /* erecovery_b         41M    p65 */
    {PART_KPATCH_B,                961 * 1024,     43 * 1024,    UFS_PART_3}, /* kpatch_b            43M    p66 */
#else
    {PART_ERECOVERY_RAMDISK_A,     566 * 1024,     32 * 1024,    UFS_PART_3}, /* erecovery_ramdisk_a 32M    p54 */
    {PART_ERECOVERY_VENDOR_A,      598 * 1024,     16 * 1024,    UFS_PART_3}, /* erecovery_vendor_a  16M    p55 */
    {PART_BOOT_A,                  614 * 1024,     30 * 1024,    UFS_PART_3}, /* boot_a              30M    p56 */
    {PART_RECOVERY_A,              644 * 1024,     45 * 1024,    UFS_PART_3}, /* recovery_a          45M    p57 */
    {PART_ERECOVERY_A,             689 * 1024,     45 * 1024,    UFS_PART_3}, /* erecovery_a         45M    p58 */
    {PART_METADATA,                734 * 1024,     16 * 1024,    UFS_PART_3}, /* metadata            16M    p59 */
    {PART_KPATCH_A,                750 * 1024,     43 * 1024,    UFS_PART_3}, /* kpatch_a            43M    p60 */
    {PART_ERECOVERY_RAMDISK_B,     793 * 1024,     32 * 1024,    UFS_PART_3}, /* erecovery_ramdisk_b 32M    p61 */
    {PART_ERECOVERY_VENDOR_B,      825 * 1024,     16 * 1024,    UFS_PART_3}, /* erecovery_vendor_b  16M    p62 */
    {PART_BOOT_B,                  841 * 1024,     30 * 1024,    UFS_PART_3}, /* boot_b              30M    p63 */
    {PART_RECOVERY_B,              871 * 1024,     45 * 1024,    UFS_PART_3}, /* recovery_b          45M    p64 */
    {PART_ERECOVERY_B,             916 * 1024,     45 * 1024,    UFS_PART_3}, /* erecovery_b         45M    p65 */
    {PART_KPATCH_B,                961 * 1024,     43 * 1024,    UFS_PART_3}, /* kpatch_b            43M    p66 */
#endif
