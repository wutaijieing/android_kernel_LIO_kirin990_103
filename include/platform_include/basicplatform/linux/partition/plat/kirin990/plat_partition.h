#ifndef _TAURUS_PLAT_PARTITION_H_
#define _TAURUS_PLAT_PARTITION_H_
...
static struct partition partition_table_ufs[] = {
    ...
    {PART_BOOT,                      622 * 1024,         30 * 1024,    UFS_PART_3}, /* boot              30M    p42 */
    {PART_RECOVERY,                  652 * 1024,         41 * 1024,    UFS_PART_3}, /* recovery          41M    p43 */
    {PART_ERECOVERY,                 693 * 1024,         41 * 1024,    UFS_PART_3}, /* erecovery         41M    p44 */
    {PART_METADATA,                  734 * 1024,         16 * 1024,    UFS_PART_3}, /* metadata          16M    p45 */
    {PART_KPATCH,                    750 * 1024,         43 * 1024,    UFS_PART_3}, /* reserved          43M    p46 */
#else
    {PART_ERECOVERY_RAMDISK,         566 * 1024,         32 * 1024,    UFS_PART_3}, /* erecovery_ramdisk 32M    p40 */
    {PART_ERECOVERY_VENDOR,          598 * 1024,         16 * 1024,    UFS_PART_3}, /* erecovery_vendor  16M    p41 */
    {PART_BOOT,                      614 * 1024,         30 * 1024,    UFS_PART_3}, /* boot              30M    p42 */
    {PART_RECOVERY,                  644 * 1024,         45 * 1024,    UFS_PART_3}, /* recovery          45M    p43 */
    {PART_ERECOVERY,                 689 * 1024,         45 * 1024,    UFS_PART_3}, /* erecovery         45M    p44 */
    {PART_METADATA,                  734 * 1024,         16 * 1024,    UFS_PART_3}, /* metadata          16M    p45 */
    {PART_KPATCH,                    750 * 1024,         43 * 1024,    UFS_PART_3}, /* reserved          43M    p46 */
#endif
