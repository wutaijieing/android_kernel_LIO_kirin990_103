#ifndef _TAURUS_CS2_PLAT_PARTITION_H_
#define _TAURUS_CS2_PLAT_PARTITION_H_
...
static const struct partition partition_table_emmc[] = {
    ...
    {PART_BOOT,                      642 * 1024,     30 * 1024,    EMMC_USER_PART}, /* boot              30M    p46 */
    {PART_RECOVERY,                  672 * 1024,     41 * 1024,    EMMC_USER_PART}, /* recovery          41M    p47 */
    {PART_ERECOVERY,                 713 * 1024,     41 * 1024,    EMMC_USER_PART}, /* erecovery         41M    p48 */
    {PART_METADATA,                  754 * 1024,     16 * 1024,    EMMC_USER_PART}, /* metadata          16M    p49 */
    {PART_KPATCH,                    770 * 1024,     61 * 1024,    EMMC_USER_PART}, /* reserved          61M    p50 */
#else
    {PART_ERECOVERY_RAMDISK,         586 * 1024,     32 * 1024,    EMMC_USER_PART}, /* erecovery_ramdisk 32M    p44 */
    {PART_ERECOVERY_VENDOR,          618 * 1024,     16 * 1024,    EMMC_USER_PART}, /* erecovery_vendor  16M    p45 */
    {PART_BOOT,                      634 * 1024,     30 * 1024,    EMMC_USER_PART}, /* boot              30M    p46 */
    {PART_RECOVERY,                  664 * 1024,     45 * 1024,    EMMC_USER_PART}, /* recovery          45M    p47 */
    {PART_ERECOVERY,                 709 * 1024,     45 * 1024,    EMMC_USER_PART}, /* erecovery         45M    p48 */
    {PART_METADATA,                  754 * 1024,     16 * 1024,    EMMC_USER_PART}, /* metadata          16M    p49 */
    {PART_KPATCH,                    770 * 1024,     61 * 1024,    EMMC_USER_PART}, /* reserved          61M    p50 */
#endif
...
static struct partition partition_table_ufs[] = {
    ...
    {PART_BOOT,                      634 * 1024,     30 * 1024,    UFS_PART_3}, /* boot              30M    p42 */
    {PART_RECOVERY,                  664 * 1024,     41 * 1024,    UFS_PART_3}, /* recovery          41M    p43 */
    {PART_ERECOVERY,                 705 * 1024,     41 * 1024,    UFS_PART_3}, /* erecovery         41M    p44 */
    {PART_METADATA,                  746 * 1024,     16 * 1024,    UFS_PART_3}, /* metadata          16M    p45 */
    {PART_KPATCH,                    762 * 1024,     61 * 1024,    UFS_PART_3}, /* reserved          61M    p46 */
#else
    {PART_ERECOVERY_RAMDISK,         578 * 1024,     32 * 1024,    UFS_PART_3}, /* erecovery_ramdisk 32M    p40 */
    {PART_ERECOVERY_VENDOR,          610 * 1024,     16 * 1024,    UFS_PART_3}, /* erecovery_vendor  16M    p41 */
    {PART_BOOT,                      626 * 1024,     30 * 1024,    UFS_PART_3}, /* boot              30M    p42 */
    {PART_RECOVERY,                  656 * 1024,     45 * 1024,    UFS_PART_3}, /* recovery          45M    p43 */
    {PART_ERECOVERY,                 701 * 1024,     45 * 1024,    UFS_PART_3}, /* erecovery         45M    p44 */
    {PART_METADATA,                  746 * 1024,     16 * 1024,    UFS_PART_3}, /* metadata          16M    p45 */
    {PART_KPATCH,                    762 * 1024,     61 * 1024,    UFS_PART_3}, /* reserved          61M    p46 */
#endif
