...
static const struct partition partition_table_emmc[] = {
    ...
    {PART_USERDATA,            13688 * 1024, (8UL) * 1024 * 1024,    EMMC_USER_PART}, /* userdata     8G    p80 */
#else
    ...
    {PART_USERDATA,            10312 * 1024, (8UL) * 1024 * 1024,    EMMC_USER_PART}, /* userdata     8G    p72 */
    ...
    {PART_USERDATA,            11136 * 1024, (8UL) * 1024 * 1024,    EMMC_USER_PART}, /* userdata     8G    p72 */
    ...
    {PART_USERDATA,             9706 * 1024, (8UL) * 1024 * 1024,    EMMC_USER_PART}, /* userdata     8G    p75 */
    ...
    {PART_USERDATA,            10410 * 1024, (8UL) * 1024 * 1024,    EMMC_USER_PART}, /* userdata     8G    p75 */
#else
    {PART_METADATA,             1184 * 1024,     16 * 1024,    EMMC_USER_PART}, /* metadata          16M    p69 */
    {PART_PREAS,                1200 * 1024,   1280 * 1024,    EMMC_USER_PART}, /* preas           1280M    p70 */
    {PART_PREAVS,               2480 * 1024,     32 * 1024,    EMMC_USER_PART}, /* preavs            32M    p71 */
    ...
    {PART_VERSION,             10752 * 1024,    576 * 1024,    EMMC_USER_PART}, /* version          576M    p73 */
    {PART_PRELOAD,             11328 * 1024,   1144 * 1024,    EMMC_USER_PART}, /* preload         1144M    p74 */
    {PART_USERDATA,            12472 * 1024,  (8UL) * 1024 * 1024,   EMMC_USER_PART}, /* userdata     8G    p75 */
#endif
    ...
    {PART_USERDATA,            12472 * 1024, (8UL) * 1024 * 1024,    EMMC_USER_PART}, /* userdata     8G    p72 */
#elif defined CONFIG_MARKET_OVERSEA
    ...
    {PART_USERDATA,            13600 * 1024, (8UL) * 1024 * 1024,    EMMC_USER_PART}, /* userdata     8G    p72 */
#elif defined CONFIG_MARKET_FULL_INTERNAL
    {PART_METADATA,             1184 * 1024,     16 * 1024,    EMMC_USER_PART}, /* metadata          16M    p69 */
    ...
    {PART_USERDATA,            11738 * 1024,  (8UL) * 1024 * 1024,   EMMC_USER_PART}, /* userdata     8G    p75 */
#elif defined CONFIG_MARKET_FULL_OVERSEA
    {PART_METADATA,             1184 * 1024,     16 * 1024,    EMMC_USER_PART}, /* metadata          16M    p69 */
    {PART_PREAS,                1200 * 1024,   1280 * 1024,    EMMC_USER_PART}, /* preas           1280M    p70 */
    {PART_PREAVS,               2480 * 1024,     32 * 1024,    EMMC_USER_PART}, /* preavs            32M    p71 */
    ...
    {PART_USERDATA,            12866 * 1024, (8UL) * 1024 * 1024,    EMMC_USER_PART}, /* userdata     8G    p75 */
#else
    {PART_METADATA,             1184 * 1024,     16 * 1024,    EMMC_USER_PART}, /* metadata          16M    p69 */
    {PART_PREAS,                1200 * 1024,   1280 * 1024,    EMMC_USER_PART}, /* preas           1280M    p70 */
    {PART_PREAVS,               2480 * 1024,     32 * 1024,    EMMC_USER_PART}, /* preavs            32M    p71 */
...
static const struct partition partition_table_ufs[] = {
    ...
    {PART_USERDATA,            13680 * 1024, (8UL) * 1024 * 1024,    UFS_PART_3}, /* userdata     8G    p76 */
#else
#ifdef CONFIG_USE_EROFS
#ifdef CONFIG_MARKET_INTERNAL
    ...
    {PART_USERDATA,            10304 * 1024, (8UL) * 1024 * 1024,    UFS_PART_3}, /* userdata     8G    p68 */
#elif defined CONFIG_MARKET_OVERSEA
    ...
    {PART_USERDATA,            11128 * 1024, (8UL) * 1024 * 1024,    UFS_PART_3}, /* userdata     8G    p68 */
#elif defined CONFIG_MARKET_FULL_INTERNAL
    {PART_METADATA,             1176 * 1024,     16 * 1024,    UFS_PART_3}, /* metadata          16M    p65 */
    ...
    {PART_USERDATA,             9698 * 1024, (8UL) * 1024 * 1024,    UFS_PART_3}, /* userdata     8G    p71 */
#elif defined CONFIG_MARKET_FULL_OVERSEA
    {PART_METADATA,             1176 * 1024,     16 * 1024,    UFS_PART_3}, /* metadata          16M    p65 */
    ...
    {PART_USERDATA,            10402 * 1024, (8UL) * 1024 * 1024,    UFS_PART_3}, /* userdata     8G    p71 */
#else
    {PART_METADATA,             1176 * 1024,     16 * 1024,    UFS_PART_3}, /* metadata          16M    p65 */
    {PART_PREAS,                1192 * 1024,   1280 * 1024,    UFS_PART_3}, /* preas            928M    p66 */
    {PART_PREAVS,               2472 * 1024,     32 * 1024,    UFS_PART_3}, /* preavs            32M    p67 */
    ...
    {PART_VERSION,             10744 * 1024,    576 * 1024,    UFS_PART_3}, /* version          576M    p69 */
    {PART_PRELOAD,             11320 * 1024,   1144 * 1024,    UFS_PART_3}, /* preload         1144M    p70 */
    {PART_USERDATA,            12464 * 1024, (8UL) * 1024 * 1024,    UFS_PART_3}, /* userdata     8G    p71 */
#endif
#else /* do not use erofs */
#ifdef CONFIG_MARKET_INTERNAL
    ...
    {PART_USERDATA,            12464 * 1024, (8UL) * 1024 * 1024,    UFS_PART_3}, /* userdata     8G    p68 */
#elif defined CONFIG_MARKET_OVERSEA
    ...
    {PART_USERDATA,            13592 * 1024, (8UL) * 1024 * 1024,    UFS_PART_3}, /* userdata     8G    p68 */
#elif defined CONFIG_MARKET_FULL_INTERNAL
    {PART_METADATA,             1176 * 1024,     16 * 1024,    UFS_PART_3}, /* metadata          16M    p65 */
    ...
    {PART_USERDATA,            11730 * 1024, (8UL) * 1024 * 1024,    UFS_PART_3}, /* userdata     8G    p71 */
#elif defined CONFIG_MARKET_FULL_OVERSEA
    {PART_METADATA,             1176 * 1024,     16 * 1024,    UFS_PART_3}, /* metadata          16M    p65 */
    ...
    {PART_USERDATA,            12858 * 1024, (8UL) * 1024 * 1024,    UFS_PART_3}, /* userdata     8G    p71 */
#else
    {PART_METADATA,             1176 * 1024,     16 * 1024,    UFS_PART_3}, /* metadata          16M    p65 */
    {PART_PREAS,                1192 * 1024,   1280 * 1024,    UFS_PART_3}, /* preas            928M    p66 */
    {PART_PREAVS,               2472 * 1024,     32 * 1024,    UFS_PART_3}, /* preavs            32M    p67 */
