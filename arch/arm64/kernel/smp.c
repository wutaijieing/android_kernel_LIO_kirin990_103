...
#ifdef CONFIG_ARM64_VM_PSCI
	/*
	*  This is used to notify virtual machine manager secondary CPU
	*  has been powered on finish
	*/
	struct arm_smccc_res res;
	arm_smccc_smc(VM_PSCI_CPU_ON_FINISH, 0, 0, 0, 0, 0, 0, 0, &res);
	pr_info("CPU%u: CPU_ON_FINISH ret: %lx\n", cpu, res.a0);
#endif
