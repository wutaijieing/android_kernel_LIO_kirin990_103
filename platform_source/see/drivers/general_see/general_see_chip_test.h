 ...
 * Description: implement general see chip factory test function
 * Create: 2020-02-17
 */
#ifndef GENERAL_SEE_CHIP_TEST_H
#define GENERAL_SEE_CHIP_TEST_H
...
#ifdef CONFIG_GENERAL_SEE_SUPPORT_8_COS
