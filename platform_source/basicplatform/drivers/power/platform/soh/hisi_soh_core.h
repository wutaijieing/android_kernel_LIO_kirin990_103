...
struct acr_nv_info {
	...
	struct bat_acr_info soh_nv_acr_info[SOH_ACR_NV_DATA_NUM];
};
...
struct soh_acr_device {
	struct bat_acr_info          soh_acr_info;
