...
static void hufs_wait_memory_repair(struct hufs_host *host)
{
...
static void hufs_rx_dme_set(struct ufs_hba *hba)
{
	/* Gear1 Synclength */
...
static int hufs_dme_setup_snps_asic_mphy(struct ufs_hba *hba)
{
	uint32_t value1 = 0;
	int err;
	struct hufs_host *host = (struct hufs_host *)hba->priv;
