...
static const struct fixed_rate_clock fixed_clks[] = {
	...
	{ CLK_SDPLL, "clk_sdpll", NULL, 0, 1928000000, "clk_sdpll" },
...
static const struct gate_clock crgctrl_gate_clks[] = {
	...
	{ CLK_GATE_ODT_DEFLATE, "clk_odt_deflat", "clk_odtdef_div", 0, 0x0, 0,
...
static const struct scgt_clock crgctrl_scgt_clks[] = {
	...
	{ CLK_ODT_DEFLATE_GT, "clk_odt_def_gt", "clk_spll",
		0x0fc, 9, CLK_GATE_HIWORD_MASK, "clk_odt_def_gt" },
...
static const struct div_clock crgctrl_div_clks[] = {
	...
	{ CLK_DIV_ODT_DEFLATE, "clk_odtdef_div", "clk_odt_def_gt",
		0x700, 0x3e00, 32, 1, 0, "clk_odtdef_div" },
...
static const struct gate_clock hsdt1ctrl_gate_clks[] = {
	...
	{ HCLK_GATE_SDIO, "hclk_sdio", "clk_div_hsdt1bus", 0x00, 0x20, 0,
...
static const struct dvfs_clock dvfs_clks[] = {
	...
	{ ACLK_GATE_VENC, "aclk_venc", "aclk_vencfreq", 39, -1, 2, 1,
		{ 335000, 418000, 642000}, { 0, 1, 2 }, 418000, 1, "aclk_venc"},
};
...
{
	struct clock_data *clk_data = NULL;
	int nr = ARRAY_SIZE(sctrl_fsm_pll_clks) +
