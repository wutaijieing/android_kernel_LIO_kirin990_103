...
static const struct xfreq_clock xfreq_clks[] = {
	...
	{ CLK_L1BUS_MIN, "clk_l1bus_min", 6, 1, 0x8000, 0x230, {0x00040309, 0x0}, {0x0004020A, 0x0}, "clk_l1bus_min" },
};
...
static struct media_pll_info ppll2b_info = MEDIA_PLL_INFO("clk_ppll2b_media", 1280000);
static struct media_pll_info ppll0_info = MEDIA_PLL_INFO("clk_ppll0_media", 1660000);
static struct media_pll_info ppll2_info = MEDIA_PLL_INFO("clk_ppll2_media", 960000);
static struct media_pll_info ppll3_info = MEDIA_PLL_INFO("clk_ppll3_media", 1200000);
static struct media_pll_info *media1crg_plls[] = {
	&ppll2b_info, &ppll0_info, &ppll2_info, &ppll3_info,
};

static const struct fast_dvfs_clock fast_dvfs_clks[] = {
	{ CLK_GATE_ISPFUNCFREQ, "clk_ispfuncfreq", {0x06C, 0x3c0, 6}, {0x06C, 0x3f, 0},
		{0x084, 6}, {0x00, 13}, media1crg_plls, ARRAY_SIZE(media1crg_plls),
		{103750, 207500, 332000, 480000, 640000}, 4, {1, 1, 1, 2, 0},
	...
	{ CLK_GATE_ISPFUNC2FREQ, "clk_ispfunc2freq", {0x06C, 0x3c00, 10}, {0x088, 0x3f0, 4},
		{0x084, 2}, {0x000, 22}, media1crg_plls, ARRAY_SIZE(media1crg_plls),
		{103750, 207500, 332000, 480000, 640000}, 4, {1, 1, 1, 2, 0},
	...
	{ CLK_GATE_ISPFUNC3FREQ, "clk_ispfunc3freq", {0x070, 0x3c00, 10}, {0x088, 0xfc00, 10},
		{0x084, 1}, {0x000, 21}, media1crg_plls, ARRAY_SIZE(media1crg_plls),
		{103750, 166000, 300000, 400000, 553000}, 4, {1, 1, 3, 3, 1},
	...
	{ CLK_GATE_ISPFUNC4FREQ, "clk_ispfunc4freq", {0x078, 0x78, 3}, {0x074, 0xfc00, 10},
		{0x084, 0}, {0x000, 5}, media1crg_plls, ARRAY_SIZE(media1crg_plls),
		{103750, 184000, 300000, 400000, 553000}, 4, {1, 1, 3, 3, 1},
	...
	{ CLK_GATE_ISPFUNC5FREQ, "clk_ispfunc5freq", {0x060, 0xf, 0}, {0x060, 0x3f0, 4},
		{0x084, 10}, {0x000, 16}, media1crg_plls, ARRAY_SIZE(media1crg_plls),
		{103750, 207500, 332000, 480000, 640000}, 4, {1, 1, 1, 2, 0},
	...
	{ CLK_GATE_MEDIA_COMMONFREQ, "clk_media_commonfreq", {0x80, 0xf000, 12}, {0x80, 0xfc0, 6},
		{0x84, 11}, {0x10, 12}, media1crg_plls, ARRAY_SIZE(media1crg_plls),
		{103750, 237140, 400000, 480000, 640000}, 4, {1, 1, 3, 2, 0},
	...
	{ CLK_GATE_MMBUF, "clk_mmbuf", {0x88, 0xf, 0}, {0x7C, 0xfc00, 10},
		{0x84, 14}, {0x20, 0}, media1crg_plls, ARRAY_SIZE(media1crg_plls),
		{103750, 207500, 276660, 332000, 480000}, 4, {1, 1, 1, 1, 2},
	...
	{ CLK_GATE_EDC0FREQ, "clk_edc0freq", {0x68, 0x3c0, 6}, {0x68, 0x3f, 0},
		{0x84, 7}, {0x00, 15}, media1crg_plls, ARRAY_SIZE(media1crg_plls),
		{103750, 237140, 400000, 480000, 640000}, 4, {1, 1, 3, 2, 0},
