...
#define PMU0_MNTN_COMP_STR "pmic-mntn-spmi"
#define PMU1_MNTN_COMP_STR "sub-pmic-mntn-spmi"

#ifndef SOC_SCTRL_SCPEREN1_ADDR
#define SOC_SCTRL_SCPEREN1_ADDR(base)         SOC_SCTRL_SCPEREN0_ADDR(base)
#define SOC_SCTRL_SCPERCLKEN1_ADDR(base)      SOC_SCTRL_SCPERCLKEN0_ADDR(base)
#define SOC_SCTRL_SCPEREN1_wait_ddr_selfreflash_done_bypass_START  \
               SOC_SCTRL_SCPEREN0_wait_ddr_selfreflash_done_bypass_START
#endif
