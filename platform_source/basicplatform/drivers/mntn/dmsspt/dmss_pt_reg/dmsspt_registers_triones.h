...
#ifndef _DMSSPT_REGISTERS_TRIONES_H_
#define _DMSSPT_REGISTERS_TRIONES_H_

#define PLATFORM_LIST \
	{.compatible = "hisilicon,triones-dmsspt",}, \
	{},\

#define DDRC_DMI_NUM	1

/* pattern trace's related registers */
#define SOC_DMSS_GLB_INT_STATUS_STR	SOC_DMSS_GLB_INT_STATUS_UNION
#define SOC_DMSS_GLB_INT_CLEAR_STR	SOC_DMSS_GLB_INT_CLEAR_UNION
#define SOC_DMSS_GLB_INT_STATUS_PTR	SOC_DMSS_GLB_INT_STATUS_ADDR
#define SOC_DMSS_GLB_INT_CLEAR_PTR	SOC_DMSS_GLB_INT_CLEAR_ADDR
