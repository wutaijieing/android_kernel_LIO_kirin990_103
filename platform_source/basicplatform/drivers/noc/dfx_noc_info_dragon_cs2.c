...
static char *cfg_targetflow_array[] = {
	...
	"noc_fd_cfg",				      /* 13 */
	"GPU(noc_gpu_cfg)",			      /* 14 */
	"GENERAL_SEE(noc_general_see_cfg_0)",		      /* 15 */
...
struct noc_mid_info noc_mid_dragon_cs2[] = {
	...
	{1, 0xFF, 0x003f, 0x3D, "CRYPTO_ENHANCE_MMU_PTW"},
	{1, 0xFF, 0x003f, 0x3E, "CRYPTO_ENHANCE_ARC"},
	{1, 0xFF, 0x003f, 0x3F, "CRYPTO_ENHANCE_SCE"},
};
