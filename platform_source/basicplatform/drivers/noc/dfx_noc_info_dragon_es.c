...
static char *cfg_targetflow_array[] = {
	...
	"noc_fd_cfg",				      /* 10 */
	"GPU(noc_gpu_cfg)",			      /* 11 */
	"GENERAL_SEE(noc_general_see_cfg_0)",		      /* 12 */
...
static const struct datapath_routid_addr cfgsys_routeid_addr_tbl[] = {
	...
	{0x03, 0x12, 0x0, 0xfa230000}, /* GENERAL_SEE(noc_general_see_cfg_0) */
	{0x03, 0x12, 0x1, 0xfa220000}, /* GENERAL_SEE(noc_general_see_cfg_0) */
...
struct noc_mid_info noc_mid_dragon_es[] = {
	...
	{2, 0xFF, 0x003f, 0x3D, "CRYPTO_ENHANCE_MMU_PTW"},
	{2, 0xFF, 0x003f, 0x3E, "CRYPTO_ENHANCE_ARC"},
	{2, 0xFF, 0x003f, 0x3F, "CRYPTO_ENHANCE_SCE"},
};

struct noc_sec_info noc_sec_dragon_es[] = {
...
struct noc_dump_reg noc_dump_reg_list_dragon_es[] = {
 ...
 */
const struct noc_busid_initflow dfx_filter_initflow_dragon_es[] = {
...
const struct noc_bus_info noc_buses_info_dragon_es[] = {
	[0] = {
		...
		.p_noc_mid_info = noc_mid_dragon_es,
		.noc_mid_info_size = ARRAY_SIZE_NOC(noc_mid_dragon_es),
		.p_noc_sec_info = noc_sec_dragon_es,
		.noc_sec_info_size = ARRAY_SIZE_NOC(noc_sec_dragon_es),
	},
	[1] = {
		.name = "vcodec_bus",
 ...
 */
void dfx_noc_get_array_size_dragon_es(unsigned int *bus_info_size, unsigned int *dump_list_size)
{
	if ((bus_info_size == NULL) || (dump_list_size == NULL))
		return;

	*bus_info_size  = ARRAY_SIZE_NOC(noc_buses_info_dragon_es);
	*dump_list_size = ARRAY_SIZE_NOC(noc_dump_reg_list_dragon_es);
}

/*
 * dfx_noc_clock_enable - check noc clock state : on or off
 * @noc_dev : dfx noc device poiter
 * @node: dfx noc node poiter
 *
 * If clock enable, return 1, else return 0;
 */
unsigned int dfx_noc_clock_enable_dragon_es(struct dfx_noc_device *noc_dev,
