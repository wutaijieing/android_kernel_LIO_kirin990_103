...
#ifndef __SLIMBUS_DRV_AUX_H__
#define __SLIMBUS_DRV_AUX_H__

#include <linux/types.h>

# define SLOTS_PER_SUPERFRAME 1536
# define MAX_CHANNEL_NUMBER 15
# define MAX_CHANNELS (MAX_CHANNEL_NUMBER + 1)
 ...
 * Values of the fields matches those defined in slimbus_drv_api.h
...
typedef struct {
	...
	channel_desc channels[MAX_CHANNELS * 2];
	uint16_t slots[SLOTS_PER_SUPERFRAME];
