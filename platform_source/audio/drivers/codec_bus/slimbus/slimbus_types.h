...
enum da_combine_v5_bus_track_type {
	DA_COMBINE_V5_BUS_TRACK_BEGIN = 0,
	DA_COMBINE_V5_BUS_TRACK_AUDIO_PLAY = DA_COMBINE_V5_BUS_TRACK_BEGIN,
	DA_COMBINE_V5_BUS_TRACK_AUDIO_CAPTURE,
	DA_COMBINE_V5_BUS_TRACK_VOICE_DOWN,
	DA_COMBINE_V5_BUS_TRACK_VOICE_UP,
	DA_COMBINE_V5_BUS_TRACK_ECREF,
	DA_COMBINE_V5_BUS_TRACK_SOUND_TRIGGER,
	DA_COMBINE_V5_BUS_TRACK_DEBUG,
	DA_COMBINE_V5_BUS_TRACK_DIRECT_PLAY,
	DA_COMBINE_V5_BUS_TRACK_2PA_IV,
	DA_COMBINE_V5_BUS_TRACK_4PA_IV,
	DA_COMBINE_V5_BUS_TRACK_AUDIO_PLAY_D3D4,
	DA_COMBINE_V5_BUS_TRACK_KWS,
	DA_COMBINE_V5_BUS_TRACK_5MIC_CAPTURE,
	DA_COMBINE_V5_BUS_TRACK_VOICE_UP_4PA,
	DA_COMBINE_V5_BUS_TRACK_BT_DOWN,
	DA_COMBINE_V5_BUS_TRACK_BT_UP,
	DA_COMBINE_V5_BUS_TRACK_ULTRA_UP,
	DA_COMBINE_V5_BUS_TRACK_TYPE_MAX,
};

enum da_combine_v3_track_type {
	DA_COMBINE_V3_BUS_TRACK_BEGIN = 0,
	DA_COMBINE_V3_BUS_TRACK_AUDIO_PLAY = DA_COMBINE_V3_BUS_TRACK_BEGIN,
	DA_COMBINE_V3_BUS_TRACK_AUDIO_CAPTURE,
	DA_COMBINE_V3_BUS_TRACK_VOICE_DOWN,
	DA_COMBINE_V3_BUS_TRACK_VOICE_UP,
	DA_COMBINE_V3_BUS_TRACK_IMAGE_LOAD,
	DA_COMBINE_V3_BUS_TRACK_ECREF,
	DA_COMBINE_V3_BUS_TRACK_SOUND_TRIGGER,
	DA_COMBINE_V3_BUS_TRACK_DEBUG,
	DA_COMBINE_V3_BUS_TRACK_DIRECT_PLAY,
	DA_COMBINE_V3_BUS_TRACK_FAST_PLAY,
	DA_COMBINE_V3_BUS_TRACK_KWS,
	DA_COMBINE_V3_BUS_TRACK_TYPE_MAX,
};

struct scene_match_track {
	const char *codec_scene;
	uint32_t track;
};
