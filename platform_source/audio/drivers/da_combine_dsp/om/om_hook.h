...
#include <linux/platform_drivers/da_combine/asp_dma.h>
...
int da_combine_dsp_hook_init(struct da_combine_irq *irqmgr, unsigned int codec_type, enum bustype_select bus_sel);
