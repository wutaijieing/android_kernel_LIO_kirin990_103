...
/* Define the union U_UNDISTORT_FIRST */
union U_UNDISTORT_FIRST {
	/* Define the struct bits */
	struct {
		unsigned int    first     : 21  ; /* [20:0] */
...
/* Define the union U_UNDISTORT_SECOND */
union U_UNDISTORT_SECOND {
	/* Define the struct bits */
	struct {
		unsigned int    second     : 21  ; /* [20:0] */
...
/* Define the union U_UNDISTORT_THIRD */
union U_UNDISTORT_THIRD {
	/* Define the struct bits */
	struct {
		unsigned int    third     : 21  ; /* [20:0] */
...
struct S_ORB_REGS_TYPE {
	...
	union U_UNDISTORT_FIRST       UNDISTORT_FIRST       ; /* 78 */
	union U_UNDISTORT_SECOND       UNDISTORT_SECOND       ; /* 7C */
	union U_UNDISTORT_THIRD       UNDISTORT_THIRD       ; /* 80 */
