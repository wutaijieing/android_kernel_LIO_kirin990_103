...
static inline void clist_init(struct clist_head *list)
{
 ...
 */
static inline void clist_deinit(struct clist_head *list, cnode_func node_release)
{
 ...
 */
static inline void clist_dump(struct clist_head *list, cnode_func node_dump)
{
	struct cnode *node = NULL, *tmp = NULL;
