...
static int dptx_dsc_para_init_fill_input_dsc_info_from_ifbc_type(struct dp_ctrl *dptx,
...
void dptx_dsc_para_init(struct dp_ctrl *dptx)
{
	...
	if (dptx_dsc_para_init_fill_input_dsc_info_from_ifbc_type(dptx, &input_dsc_info) != 0)
		return;
