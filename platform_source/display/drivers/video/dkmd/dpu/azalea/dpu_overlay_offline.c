...
bool dpu_offline_chn_include_online_chn(
...
static int dpu_check_panel_status_and_composer_type(dss_overlay_t *pov_req)
{
	int32_t wb_type;
	...
	dss_overlay_t **pov_req_out)
{
	...
	ret = dpu_check_panel_status_and_composer_type(pov_req);
	if (ret != 0) {
		dpu_offline_play_free_data(pov_req);
