...
int display_engine_color_rectify_param_get(struct dpu_fb_data_type *dpufd,
...
int display_engine_share_mem_get(struct dpu_fb_data_type *dpufd,
...
int display_engine_ddic_cabc_param_get(struct dpu_fb_data_type *dpufd,
...
int display_engine_ddic_color_param_get(struct dpu_fb_data_type *dpufd,
...
int display_engine_ddic_rgbw_param_get(struct dpu_fb_data_type *dpufd,
