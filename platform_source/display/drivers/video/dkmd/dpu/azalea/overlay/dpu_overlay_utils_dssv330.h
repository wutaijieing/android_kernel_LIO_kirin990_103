...
#include "dpu_overlay_utils_array_dssv330.h"
...
#define GPIO_PG_SEL_A 168  /* PIO_21_0 */
#define GPIO_TX_RX_A 170  /* GPIO_21_2 */
#define GPIO_PG_SEL_B 133  /* GPIO_16_5 */
#define GPIO_TX_RX_B 135  /* GPIO_16_7 */

#define CRGPERI_PLL0_CLK_RATE 1622016000UL
#define CRGPERI_PLL2_CLK_RATE 1920000000UL
#define CRGPERI_PLL3_CLK_RATE 1200000000UL


/* core_clk(clk_edc0): 0.6v-231.72M, 0.65v-320M, 0.7V-384M, 0.8V400M */
#define DEFAULT_DSS_CORE_CLK_080V_RATE 400000000UL
#define DEFAULT_DSS_CORE_CLK_070V_RATE 384000000UL
#define DEFAULT_DSS_CORE_CLK_065V_RATE 320000000UL
#define DEFAULT_DSS_CORE_CLK_060V_RATE 232000000UL
#define TEMP_DSS_CORE_CLK_RATE 200000000UL

/* mdc_clk(fb2): 0.6v-232M, 0.65v-320M, 0.7V-384M, 0.8V-400M */
#define DEFAULT_MDC_CORE_CLK_RATE_L4 400000000UL
#define DEFAULT_MDC_CORE_CLK_RATE_L3 384000000UL
#define DEFAULT_MDC_CORE_CLK_RATE_L2 320000000UL
#define DEFAULT_MDC_CORE_CLK_RATE_L1 232000000UL

#define DEFAULT_PCLK_DSS_RATE 320000000UL  /* pclk_mmbuf  maby no use */
#define DEFAULT_PCLK_PCTRL_RATE 80000000UL  /* CONFIG_PCLK_PCTRL_USED */


/* core_clk(clk_edc0): 0.6v-231.72M, 0.65v-320M, 0.7V-384M, 0.8V400M */
#define DEFAULT_DSS_CORE_CLK_RATE_L4 400000000UL
#define DEFAULT_DSS_CORE_CLK_RATE_L3 384000000UL
#define DEFAULT_DSS_CORE_CLK_RATE_L2 320000000UL
#define DEFAULT_DSS_CORE_CLK_RATE_L1 232000000UL

#define DEFAULT_DSS_CORE_CLK_RATE 400000000UL

/* mmbuf_clk: 0.8v,0.7v,0.65v,0.6v-320M */
#define DEFAULT_DSS_MMBUF_CLK_RATE_L4 320000000UL
#define DEFAULT_DSS_MMBUF_CLK_RATE_L3 320000000UL
#define DEFAULT_DSS_MMBUF_CLK_RATE_L2 320000000UL
#define DEFAULT_DSS_MMBUF_CLK_RATE_L1 320000000UL


/* pix0_clk(clk_ldi0): 0.8v,0.7v,0.65v,0.6v-231.72M */
#define DEFAULT_DSS_PXL0_CLK_RATE_L4 232000000UL
#define DEFAULT_DSS_PXL0_CLK_RATE_L3 232000000UL
#define DEFAULT_DSS_PXL0_CLK_RATE_L2 232000000UL
#define DEFAULT_DSS_PXL0_CLK_RATE_L1 232000000UL


/* dss clk power off */
#define DEFAULT_DSS_CORE_CLK_RATE_POWER_OFF 232000000UL
#define DEFAULT_DSS_PXL0_CLK_RATE_POWER_OFF 232000000UL
...
#define DPUFB_PLATFORM_TYPE (FB_ACCEL_DSSV330 | FB_ACCEL_PLATFORM_TYPE_ASIC)
