...
#define CRGPERI_PLL2_CLK_RATE (1920000000UL) /* double 9a0 */
...
#define DEFAULT_DSS_CORE_CLK_RATE_L1 (240000000UL) /* max for (240000000UL) */

#define DEFAULT_DSS_CORE_CLK_INTERIM_RATE (320000000UL) /* Interim rate in PPLL2, for dss and mdc */
...
#define DEFAULT_DSS_MMBUF_CLK_RATE_L0 (192000000UL)
...
#define DPU_DPP_MAX_SUPPORT_BIT (0x1fff) /* 13 dpp module, 13bit, contrast to enmu dpp_module_idx */
#define DPUFB_PLATFORM_TYPE (FB_ACCEL_DSSV360 | FB_ACCEL_PLATFORM_TYPE_ASIC)

/* scl */
#define SCF_LINE_BUF (2560)

/* AIF */
#define DSS_AIF0_CH_LS 0x40081 /* follow devner */
#define DSS_AIF1_CH_LS 0x40081 /* follow devner */
...
#define TUI_SEC_RCH (DSS_RCHN_D3) /* RCH1 */
