 ...
 *
 */
#ifndef _DPU_OVERLAY_UTILS_DSSV510_H_
#define _DPU_OVERLAY_UTILS_DSSV510_H_
...
#define DPUFB_PLATFORM_TYPE  (FB_ACCEL_DSSV510 | FB_ACCEL_PLATFORM_TYPE_ASIC)
...
#endif  /* _DPU_OVERLAY_UTILS_DSSV510_H_ */
