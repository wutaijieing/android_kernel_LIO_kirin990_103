...
#ifndef ELLIPTIC_SYSTEM_TYPES_H
#define ELLIPTIC_SYSTEM_TYPES_H
...
#define ELP_STATUS                      int16_t   /* Macro for system API return value. */
/**
 * \endcond
 * @}
 */
 ...
 */
#define ELP_SYSTEM_INFO                 int16_t   /* Macro for system API return information. */
/**
 * \endcond
 * @}
 */
