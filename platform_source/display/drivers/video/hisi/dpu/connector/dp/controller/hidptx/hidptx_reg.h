...
#define DPTX_VCC_DISRESET_N_OFFSET 0x64
#define DPTX_VCC_DISRESET_N_BIT BIT(1)
#define DPTX_VCC_RESET_N_OFFSET 0x60
#define DPTX_VCC_RESET_N_BIT BIT(0)
...
*/
#define DPTX_AUX_CMD_REQ_LEN_SHIFT					4 /* B021 */
#define DPTX_AUX_CMD_I2C_ADDR_ONLY					BIT(28) /*B021*/
#define DPTX_AUX_CMD_ADDR_SHIFT						8
#define DPTX_AUX_CMD_TYPE_SHIFT						0 /* B021 */
...
#define DPTX_GOBAL_RST_N_MASK						GENMASK(9, 0)
...
#define DPTX_CFG_DUAL_DP_ENABLE_BIT BIT(4)
#define DPTX_CFG_MODE_SELECT_MASK GENMASK(5, 4)
...
#define DPTX_IRQ_STRAME0_INFOFRAME_SDP GENMASK(23, 16)
#define DPTX_IRQ_STRAME1_INFOFRAME_SDP GENMASK(31, 24)
#define DPTX_IRQ_STREAM0_PPS_SDP BIT(0)
...
#define DPTX_IRQ_ADAPTIVE_SYNC_SDP BIT(25)
...
#define PCLK_TUNE BIT(16)
#define CLK_TUNE_REF BIT(17)

#define HSDT1_PERRSTDIS3 0x84
#define PRST_TUNE BIT(19)


#define DPTX_PLL_RC_CTRL0 0

#define DPTX_PLL_RC_CTRL1 0x4

#define DPTX_PLL_RC_STAT0 0x10

#define DPRX_PHY_CLK_RC_STAT_NUM 0x14
#define HDMI_TMDS_CLK_RC_STAT_NUM 0x18
#define DPRX_MVID_RC_STAT_SUM_39_32 0x1C
#define DPRX_MVID_RC_STAT_SUM_31_0 0x20
#define DPRX_NVID_RC_STAT_SUM_39_32 0x24
#define DPRX_NVID_RC_STAT_SUM_31_0 0x28
#define DPRX_MVID_NVID_RC_STAT_NUM 0x2C

#define DPTX_PIX_CLK_FREQ_STAT_EN 0x40
#define DPTX_PIX_CLK_STAT_TIME 0x50
#define DPTX_PIX_CLK_STAT_NUM 0x54

#define DPTX_PIX_STAT_STATE1 0x58

#define DPTX_PLL_TUNE_CTRL 0x80
#define DPRX_SIG_SEL BIT(5)

#define DPTX_PLL_TUNE_MEAS_CTRL0 0x168
#define RX_HSYNC_MEAS_EN BIT(0)
#define RX_HSYNC_VSYNC_SEL BIT(1)
#define RX_HSYNC_MEAS_UNIT_MASK GENMASK(23, 8)
#define RX_HSYNC_MEAS_DONE BIT(24)

#define DPTX_PLL_TUNE_MEAS_STATE0 0x16C

#define DPTX_PLL_INTR_EN 0x180
#define RC_STAT_DONE_INT_ENABLE BIT(0)
#define PIX_STAT_DONE_INT_ENABLE BIT(1)
#define RXHSYNC_MEAS_DONE_INT_ENABLE BIT(9)

#define DPTX_PLL_INTR_MASK_STATUS 0x184
#define DPTX_PLL_INTR_ORI_STATUS 0x188

#define DPTX_PLL_TUNE_RST_CTRL 0x1A4
#define TURE_RST BIT(0)

#define DPTX_PLL_TUNE_GATE_CTRL 0x1A0
#define DPRX_PHY_CLK BIT(1)
#define HDMI_TMDS_CLK BIT(0)
