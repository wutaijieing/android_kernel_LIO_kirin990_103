 ...
 */
#define DEFAULT_JS_HARD_STOP_TICKS_CL    (10) /* 1s */
 ...
 * "stuck" job
 */
#define DEFAULT_JS_RESET_TICKS_SS           (15) /* 1.5s */

/**
 * Default minimum number of scheduling ticks before the GPU is reset to clear a
 * "stuck" CL job.
 */
#define DEFAULT_JS_RESET_TICKS_CL        (15) /* 1.5s */
 ...
 */
#define DEFAULT_RESET_TIMEOUT_MS (500) /* 500ms */
