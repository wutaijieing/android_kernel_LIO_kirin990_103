...
{
	pr_err("mali gpu: kbase_wait_fence_timeout, wait fence time out\n");
...
int kbase_context_common_init(struct kbase_context *kctx)
{
	...
	/* BASE_DEBUG_FENCE_TIMEOUT */
	kctx->gpu_ctx_data.timer_started = 0;
	hrtimer_init(&kctx->gpu_ctx_data.fence_wait_timer,
		CLOCK_MONOTONIC, HRTIMER_MODE_REL);
	kctx->gpu_ctx_data.fence_wait_timer.function =
