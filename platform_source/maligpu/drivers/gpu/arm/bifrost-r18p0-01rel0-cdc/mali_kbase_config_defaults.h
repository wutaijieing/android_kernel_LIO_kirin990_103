 ...
 */
#define DEFAULT_JS_HARD_STOP_TICKS_SS    (10) /* 1s, change from 5s to 1s for cdc */
#define DEFAULT_JS_HARD_STOP_TICKS_SS_8408  (300) /* 30s */

/**
 * Default minimum number of scheduling ticks before CL jobs are hard-stopped.
 */
#define DEFAULT_JS_HARD_STOP_TICKS_CL    (10) /* 1s, change from 5s to 1s for cdc */
 ...
 * "stuck" job
 */
#define DEFAULT_JS_RESET_TICKS_SS           (15) /* 1.5s, change from 5.5s to 1.5s for cdc */
 ...
 * "stuck" CL job.
 */
#define DEFAULT_JS_RESET_TICKS_CL        (15) /* 1.5s, change from 5.5s to 1.5s for cdc */
