...
#define SYS_REG_PMCTRL_BASE_ADDR        0xFFF01000
#define SYS_REG_CRG_BASE_ADDR           0xFFF05000 /* Crg control register base address */
#define SYS_REG_PCTRL_BASE_ADDR         0xFEC3E000
#else
...
#elif defined (CONFIG_MALI_NORR_PHX) || defined (CONFIG_MALI_GONDUL) || defined (CONFIG_MALI_TRYM)
