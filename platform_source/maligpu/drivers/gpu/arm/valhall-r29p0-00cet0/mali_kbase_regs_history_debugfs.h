...
#if defined(CONFIG_DFX_DEBUG_FS) && !defined(CONFIG_MALI_NO_MALI)
...
#else /* defined(CONFIG_DFX_DEBUG_FS) && !defined(CONFIG_MALI_NO_MALI) */
...
#endif /* defined(CONFIG_DFX_DEBUG_FS) && !defined(CONFIG_MALI_NO_MALI) */
