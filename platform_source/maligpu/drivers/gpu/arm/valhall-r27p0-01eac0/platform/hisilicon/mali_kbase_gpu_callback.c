 ...
 * Description: This file describe GPU callbacks
 * Create: 2014-2-24
 *
...
extern gpu_lb_callbacks lb_callbacks;
#endif
...
struct kbase_gpu_callbacks gpu_callbacks = {
#ifdef CONFIG_MALI_CL_BOOST
...
{
	return (uintptr_t)&gpu_callbacks;
}
