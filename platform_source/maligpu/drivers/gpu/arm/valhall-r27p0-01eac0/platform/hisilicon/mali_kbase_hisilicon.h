...
/**
 * struct kbase_gpu_device_data - all platform data in device level.
 *
 * @callbacks: The callbacks implements.
...
/**
 * struct kbase_gpu_ctx_data - all platform data in context level.
 *
