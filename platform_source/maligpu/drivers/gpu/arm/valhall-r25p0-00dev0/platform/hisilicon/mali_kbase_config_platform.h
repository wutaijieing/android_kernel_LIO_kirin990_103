...
#elif defined (CONFIG_MALI_TRYM) || defined (CONFIG_MALI_BORR) || defined (CONFIG_MALI_NATT) || defined (CONFIG_MALI_ODIN)
#define SYS_REG_PMCTRL_BASE_ADDR           0xFFF01000
#define SYS_REG_PERICRG_BASE_ADDR          0xFFF05000
...
#elif defined (CONFIG_MALI_TRYM) || defined (CONFIG_MALI_NATT) || defined (CONFIG_MALI_ODIN)
#define PERI_STAT_FPGA_GPU_EXIST           0xBC
...
#elif defined (CONFIG_MALI_NORR_PHX) || defined (CONFIG_MALI_GONDUL) || defined (CONFIG_MALI_TRYM) || defined (CONFIG_MALI_NATT) || defined (CONFIG_MALI_ODIN)
