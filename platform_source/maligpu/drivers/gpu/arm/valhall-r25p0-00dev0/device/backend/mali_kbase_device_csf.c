...
static int kbase_device_csf_firmware_init(struct kbase_device *kbdev)
{
	...
	kbase_reset_gpu_register_complete_cb(kbdev,
				kbase_csf_scheduler_firmware_reinit);
	return err;
}
...
static const struct kbase_device_init dev_init[] = {
	...
	{kbasep_js_minimal_devdata_init, NULL,
			"Minimal JS devdata initialization failed"},
	...
	{kbase_device_csf_firmware_init, kbase_csf_firmware_term,
