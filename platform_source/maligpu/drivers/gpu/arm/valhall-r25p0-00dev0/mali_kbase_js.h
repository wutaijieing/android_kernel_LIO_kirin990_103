...
/**
 * kbasep_js_minimal_devdata_init - Initialize the Job Scheduler data.
 *
 * Minimal Job Scheduler data init needed for CSF builds.
 */
int kbasep_js_minimal_devdata_init(struct kbase_device * const kbdev);

/**
 * kbasep_js_runpool_release_ctx - Release a reference count of a context.
 *
 */
