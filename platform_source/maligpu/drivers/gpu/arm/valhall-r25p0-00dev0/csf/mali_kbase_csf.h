 ...
 * queue groups associated with the context, deschedule them and mark them
 * as terminated (which will then lead to unbinding of all the queues bound
 * to them) and also no more work would be allowed to execute for them.
 *
