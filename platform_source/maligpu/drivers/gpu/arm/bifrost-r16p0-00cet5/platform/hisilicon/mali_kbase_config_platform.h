...
#define KBASE_PWR_OVERRIDE_VALUE        0xe036206c
#else
#define KBASE_PWR_KEY_VALUE             0x2968a819
 ...
 */
#if defined (CONFIG_MALI_GONDUL) || defined (CONFIG_MALI_NORR) || defined (CONFIG_MALI_SIGURD) || defined (CONFIG_MALI_HEIMDALL)
#define SYS_REG_PMCTRL_BASE_ADDR        0xFFF31000 /* PMCTRL control registers */
#define SYS_REG_CRG_BASE_ADDR           0xFFF35000 /* Crg control registers */
#define SYS_REG_PCTRL_BASE_ADDR         0xE8A09000 /* PCTRL control registers */
