...
int kbase_ctx_sched_init(struct kbase_device *kbdev)
{
	...
	memset(kbdev->as_to_kctx, 0, sizeof(kbdev->as_to_kctx)); /* unsafe_function_ignore: memset */ /*[false alarm]:The function kbase_ctx_sched_init() don't writes outside the bounds of as_to_kctx*/
