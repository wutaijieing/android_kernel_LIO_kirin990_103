 ...
 * @dev: Device of which the frequency status is to be taken
 ...
 * @dev: Device of which the frequency to be exited
 *
...
/**
 * devfreq_cur_freq() - gets the device current frequecy
 * @dev: device from which the frequency is to be read.
 * @freq: clock frequecy
 *
 * Return : 0 always
 */
...
/**
 * register_arb_dev() - Register arbiter device to platform operations
 * @arb_plat_dev: Arbiter platform device
 * @dev: Arbiter device handle
 * @ops: arbiter Callback functions to platform integrator
 *
 * Register arbiter device to platform operations
 *
 ...
 * @arb_plat_dev: Arbiter platform device
 *
 * Deregister arbiter device from platform operations
 */
 ...
 * @arb_plat: Arbiter platform device
