...
#define KBASE_REG_MAP_FIXED (1ul << 29)

/* Region is transient mapped into kernel space. */
#define KBASE_REG_TRANSIENT_KERNEL_MAPPING (1ul << 30)
...
#define KBASE_REG_NO_GMC (KBASE_REG_KERNEL_ONLY | KBASE_REG_DONT_NEED | KBASE_REG_TRANSIENT_KERNEL_MAPPING | KBASE_REG_ACTIVE_JIT_ALLOC)
#endif
