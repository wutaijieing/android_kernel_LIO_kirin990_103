...
void vedu_hal_cfg_reg_addr_set(const struct encode_info *channel_cfg, uint32_t *reg_base)
{
	...
	VCODEC_DBG_VENC("reg VEDU_VCPI_SRC_YADDR:%pK", (void *)(uintptr_t)(channel_cfg->all_reg.VEDU_VCPI_SRC_YADDR));
	VCODEC_DBG_VENC("reg VEDU_VCPI_SRC_CADDR:%pK", (void *)(uintptr_t)(channel_cfg->all_reg.VEDU_VCPI_SRC_CADDR));
	VCODEC_DBG_VENC("reg VEDU_VCPI_SRC_VADDR:%pK", (void *)(uintptr_t)(channel_cfg->all_reg.VEDU_VCPI_SRC_VADDR));
	VCODEC_DBG_VENC("reg vcpi_curld_c_stride:%x", channel_cfg->all_reg.VEDU_VCPI_STRIDE.bits.vcpi_curld_c_stride);
	VCODEC_DBG_VENC("reg vcpi_curld_y_stride:%x", channel_cfg->all_reg.VEDU_VCPI_STRIDE.bits.vcpi_curld_y_stride);
	if (channel_cfg->all_reg.VEDU_VCPI_STRFMT.bits.vcpi_str_fmt == 10) {
		...
		VCODEC_DBG_VENC("reg VEDU_VCPI_CH_ADDR=%pK", (void *)(uintptr_t)(channel_cfg->all_reg.VEDU_VCPI_YH_ADDR));
		VCODEC_DBG_VENC("reg VEDU_VCPI_CH_ADDR=%pK", (void *)(uintptr_t)(channel_cfg->all_reg.VEDU_VCPI_CH_ADDR));
		VCODEC_DBG_VENC("reg vcpi_curld_srcch_stride=%x", channel_cfg->all_reg.VEDU_CURLD_SRCH_STRIDE.bits.vcpi_curld_srcch_stride);
		VCODEC_DBG_VENC("reg vcpi_curld_srcyh_stride=%x", channel_cfg->all_reg.VEDU_CURLD_SRCH_STRIDE.bits.vcpi_curld_srcyh_stride);
	}
...
void vedu_hal_cfg_reg_slc_head_set(const struct encode_info *channel_cfg, uint32_t *reg_base)
{
	...
	VCODEC_DBG_VENC("set Vedu Hal SlcHead");
	all_reg = (S_HEVC_AVC_REGS_TYPE *)reg_base;
	// ----------------------------Stream head info------------------------------------------
	...
	if (channel_cfg->all_reg.VEDU_VLCST_PARAMETER.bits.vlcst_para_set_en == 1) {
		...
		VCODEC_DBG_VENC("reg VLCST_PARA_DATA0:0x%x", all_reg->VEDU_VLCST_PARA_DATA0);
		VCODEC_DBG_VENC("reg VLCST_PARA_DATA1:0x%x", all_reg->VEDU_VLCST_PARA_DATA1);
		VCODEC_DBG_VENC("reg VLCST_PARA_DATA2:0x%x", all_reg->VEDU_VLCST_PARA_DATA2);
		VCODEC_DBG_VENC("reg VLCST_PARA_DATA3:0x%x", all_reg->VEDU_VLCST_PARA_DATA3);
		VCODEC_DBG_VENC("reg VLCST_PARA_DATA4:0x%x", all_reg->VEDU_VLCST_PARA_DATA4);
		VCODEC_DBG_VENC("reg VLCST_PARA_DATA5:0x%x", all_reg->VEDU_VLCST_PARA_DATA5);
		VCODEC_DBG_VENC("reg VLCST_PARA_DATA6:0x%x", all_reg->VEDU_VLCST_PARA_DATA6);
		VCODEC_DBG_VENC("reg VLCST_PARA_DATA7:0x%x", all_reg->VEDU_VLCST_PARA_DATA7);
		VCODEC_DBG_VENC("reg VLCST_PARA_DATA8:0x%x", all_reg->VEDU_VLCST_PARA_DATA8);
...
void vedu_hal_cfg_reg_premmu_set(const struct encode_info *channel_cfg, uint32_t *reg_base)
{
	...
	all_reg = (S_HEVC_AVC_REGS_TYPE *)reg_base;
	VCODEC_DBG_VENC("MMU RRE ADDR enter");
	VCODEC_DBG_VENC("MMU_PRE_NBI_MVST_ADDR_STR:%pK, SMMU_MSTR_SMRX_1[0]:%pK, MMU_PRE_STRMADDR0_STR:%pK", (void *)(&(all_reg->MMU_PRE_NBI_MVST_ADDR_STR)),
				(&(all_reg->SMMU_MSTR_SMRX_1[0])), (void *)(uintptr_t)(&(all_reg->MMU_PRE_STRMADDR0_STR)));
	VCODEC_DBG_VENC("MMU_PRE_NBI_MVST_ADDR_STR:%pK, SMMU_MSTR_SMRX_1[0]:%pK, MMU_PRE_STRMADDR0_STR:%pK", (void *)(&(all_reg->MMU_PRE_NBI_MVST_ADDR_STR)),
				(&(all_reg->SMMU_MSTR_SMRX_1[0])), (void *)(uintptr_t)(&(all_reg->MMU_PRE_STRMADDR0_STR)));
	VCODEC_DBG_VENC("MMU_PRE_NBI_MVST_ADDR_STR:%pK, SMMU_MSTR_SMRX_2[0]:%pK, MMU_PRE_STRMADDR0_STR:%pK", (void *)(&(all_reg->MMU_PRE_NBI_MVST_ADDR_STR)),
...
void veduhal_cfgreg_rcset(const struct encode_info *channel_cfg, uint32_t *reg_base)
{
	...
	VCODEC_DBG_VENC("----qpg_qp_madi_switch_thr:%d----", channel_cfg->all_reg.VEDU_QPG_MADI_SWITCH_THR.bits.qpg_qp_madi_switch_thr);
}
