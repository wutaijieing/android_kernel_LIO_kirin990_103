...
static hwsensor_vtbl_t g_imx616_vtbl;
static bool g_power_on_status; /* false: power off, true:power on */
static struct platform_device *g_pdev;
struct mutex g_imx616_power_lock;

static int imx616_config(hwsensor_intf_t *si, void  *argp);

/* imx616 cs udp project */
static struct sensor_power_setting g_imx616_power_setting[] = {
	/* MCAM1 AVDD 2.8V */
	{
...
/* imx616 A&B project */
static struct sensor_power_setting g_imx616_power_setting_ab[] = {
...
/* ES UDP power up seq */
static struct sensor_power_setting g_imx616_power_setting_udp[] = {
...
/* Emily power up seq */
static struct sensor_power_setting g_imx616_power_setting_emily[] = {
	/* MCAM1 AVDD 2.8V */
	{
		.seq_type = SENSOR_AVDD,
		.config_val = LDO_VOLTAGE_V2P8V,
...
/* Neo power up seq */
static struct sensor_power_setting g_imx616_power_setting_neo[] = {
	/* MCAM1 AVDD 2.8V */
	{
		.seq_type = SENSOR_AVDD,
		.config_val = LDO_VOLTAGE_V2P8V,
...
/* hma power up seq */
static struct sensor_power_setting g_imx616_power_setting_hma[] = {
	/* MCAM1 AVDD 2.8V */
	{
...
/* hma power up seq */
static struct sensor_power_setting g_imx616_power_setting_laya[] = {
	/* MCAM1 AVDD 2.8V */
	{
...
atomic_t volatile g_imx616_powered = ATOMIC_INIT(0);
static sensor_t g_imx616 = {
	.intf = { .vtbl = &g_imx616_vtbl, },
	.power_setting_array = {
		.size = ARRAY_SIZE(g_imx616_power_setting),
		.power_setting = g_imx616_power_setting,
	},
	.p_atpowercnt = &g_imx616_powered,
};

static sensor_t g_imx616_ab = {
	.intf = { .vtbl = &g_imx616_vtbl, },
	.power_setting_array = {
		.size = ARRAY_SIZE(g_imx616_power_setting_ab),
		.power_setting = g_imx616_power_setting_ab,
	},
	.p_atpowercnt = &g_imx616_powered,
};

static sensor_t g_imx616_udp = {
	.intf = { .vtbl = &g_imx616_vtbl, },
	.power_setting_array = {
		.size = ARRAY_SIZE(g_imx616_power_setting_udp),
		.power_setting = g_imx616_power_setting_udp,
	},
	.p_atpowercnt = &g_imx616_powered,
};

static sensor_t g_imx616_emily = {
	.intf = { .vtbl = &g_imx616_vtbl, },
	.power_setting_array = {
		.size = ARRAY_SIZE(g_imx616_power_setting_emily),
		.power_setting = g_imx616_power_setting_emily,
	},
	.p_atpowercnt = &g_imx616_powered,
};

static sensor_t g_imx616_neo = {
	.intf = { .vtbl = &g_imx616_vtbl, },
	.power_setting_array = {
		.size = ARRAY_SIZE(g_imx616_power_setting_neo),
		.power_setting = g_imx616_power_setting_neo,
	},
	.p_atpowercnt = &g_imx616_powered,
};

static sensor_t g_imx616_hma = {
	.intf = { .vtbl = &g_imx616_vtbl, },
	.power_setting_array = {
		.size = ARRAY_SIZE(g_imx616_power_setting_hma),
		.power_setting = g_imx616_power_setting_hma,
	},
	.p_atpowercnt = &g_imx616_powered,
};

static sensor_t g_imx616_laya = {
	.intf = { .vtbl = &g_imx616_vtbl, },
	.power_setting_array = {
		.size = ARRAY_SIZE(g_imx616_power_setting_laya),
		.power_setting = g_imx616_power_setting_laya,
	},
	.p_atpowercnt = &g_imx616_powered,
};

static const struct of_device_id g_imx616_dt_match[] = {
	{
	...
	},
	{
		...
		.data = &g_imx616_ab.intf,
	},
	{
		.compatible = "huawei,imx616_udp",
		.data = &g_imx616_udp.intf,
	},
	{
		.compatible = "huawei,imx616_emily",
		.data = &g_imx616_emily.intf,
	},
	{
		.compatible = "huawei,imx616_neo",
		.data = &g_imx616_neo.intf,
	},
	{
		.compatible = "huawei,imx616_hma",
		.data = &g_imx616_hma.intf,
	},
	{
		.compatible = "huawei,imx616_laya",
		.data = &g_imx616_laya.intf,
	},
	{
	}, /* terminate list */
};
MODULE_DEVICE_TABLE(of, g_imx616_dt_match);

static struct platform_driver g_imx616_driver = {
	.driver = {
		.name = "huawei,imx616",
		.owner = THIS_MODULE,
		.of_match_table = g_imx616_dt_match,
	},
};
...
int imx616_power_down(hwsensor_intf_t *si)
{
	int ret;
	sensor_t *sensor = NULL;
...
static int imx616_match_id(hwsensor_intf_t *si, void *data)
{
	...
	if (!strncmp(sensor->board_info->name,
		"IMX616_SUNNY", strlen("IMX616_SUNNY"))) {
...
static int imx616_config(hwsensor_intf_t *si, void  *argp)
{
	...
	case SEN_CONFIG_POWER_ON:
		mutex_lock(&g_imx616_power_lock);
		...
		mutex_unlock(&g_imx616_power_lock);
		break;
...
static int32_t imx616_platform_probe(struct platform_device *pdev)
{
	...
	id = of_match_node(g_imx616_dt_match, np);
	if (!id) {
	...
	sensor->dev = &pdev->dev;
	mutex_init(&g_imx616_power_lock);
...
static int __init imx616_init_module(void)
{
	...
	return platform_driver_probe(&g_imx616_driver,
...
static void __exit imx616_exit_module(void)
{
	...
	platform_driver_unregister(&g_imx616_driver);
}
