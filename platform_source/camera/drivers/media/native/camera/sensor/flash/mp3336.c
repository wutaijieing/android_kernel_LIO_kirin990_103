...
static int hw_mp3336_get_dt_data(struct hw_flash_ctrl_t *flash_ctrl)
{
	...
	rc = of_property_read_u32(node, "vendor,flash_led_num",
		&pdata->flash_led_num);
	cam_info("%s vendor,flash_led_num %d, rc %d", __func__,
	...
	rc = of_property_read_u32(node, "vendor,torch_led_num",
		&pdata->torch_led_num);
	cam_info("%s vendor,torch_led_num %d, rc %d", __func__,
