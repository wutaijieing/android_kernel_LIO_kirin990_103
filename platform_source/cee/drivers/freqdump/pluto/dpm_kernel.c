...
struct monitor_dump_info g_monitor_info = {
	...
	.mdev[PCIE0_CTRL_PM_LINKST_IN_L0S] = {
		"PCIE0_CTRL_PM_LINKST_IN_L0S", 0, 0, 0, 0 },
	.mdev[PCIE0_CTRL_PM_LINKST_IN_L1] = {
		"PCIE0_CTRL_PM_LINKST_IN_L1", 0, 0, 0, 0 },
	.mdev[PCIE0_CTRL_PM_LINKST_IN_L1SUB] = {
		"PCIE0_CTRL_PM_LINKST_IN_L1SUB", 0, 0, 0, 0 },
	...
	.mdev[CLK_AIC_TOP_EN] = { "CLK_AIC_TOP_EN", 0, 0, 0, 0 }, /* peri0 */
	...
	.mdev[PERI_AUTODIV_STAT12] = { "PERI_AUTODIV_STAT12", 0, 0, 0, 0 },
	...
	.mdev[BIG0_SVFD] = { "BIG0_SVFD", 0, 0, 0, 0 },
	.mdev[MIDDLE0_SVFD] = { "MIDDLE0_SVFD", 0, 0, 0, 0 },
	.mdev[BIG0_IDLE] = { "BIG0_IDLE", 0, 0, 0, 0 },
	...
	.mdev[HIEPS2LM_BUSY2] = { "HIEPS2LM_BUSY2", 0, 0, 0, 0 }, /* media1 */
	...
	.mdev[IOMCU_NOC_PENDINGTRANS] = {
		"IOMCU_NOC_PENDINGTRANS", 0, 0, 0, 0 },
	...
	.mdev[FD_NOC_PENDINGTRANS] = { "FD_NOC_PENDINGTRANS", 0, 0, 0, 0 },
	.mdev[FDUL2LM_BUSY5] = { "FDUL2LM_BUSY5", 0, 0, 0, 0 },
	.mdev[FDUL2LM_BUSY4] = { "FDUL2LM_BUSY4", 0, 0, 0, 0 },
	.mdev[AIC_BUSY] = { "AIC_BUSY", 0, 0, 0, 0 },
	.mdev[DW_AXI_M2_ST] = { "DW_AXI_M2_ST", 0, 0, 0, 0 },
	.mdev[DW_AXI_M3_ST] = { "DW_AXI_M3_ST", 0, 0, 0, 0 },
	.mdev[DW_AXI_M4_ST] = { "DW_AXI_M4_ST", 0, 0, 0, 0 },
