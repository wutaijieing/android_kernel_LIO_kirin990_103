/*
 * hisi_ddr_ddrcflux_registers_cepheus.h
 *
 * ddrcflux registers message for cepheus
 *
 ...
 *
 */
#ifndef __HISI_DDR_DDRCFLUX_REGISTERS_CEPHEUS_H__
#define __HISI_DDR_DDRCFLUX_REGISTERS_CEPHEUS_H__

#define PLATFORM_LIST \
	{ .compatible = "hisilicon,cepheus-ddrc-flux", }, \
	{ },

#define DDRC_PLATFORM_NAME		CEPHEUS
#define DDRC_IRQ_CPU_CORE_NUM		8
#define DDRC_DMC_NUM		2
#define DDRC_ASI_PORT_NUM		15
