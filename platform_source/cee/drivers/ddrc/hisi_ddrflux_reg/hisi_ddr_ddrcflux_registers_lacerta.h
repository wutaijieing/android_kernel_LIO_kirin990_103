/*
 * hisi_ddr_ddrcflux_registers_lacerta.h
 *
 * ddrcflux registers message for lacerta
 *
 ...
 *
 */
#ifndef __HISI_DDR_DDRCFLUX_REGISTERS_LACERTA_H__
#define __HISI_DDR_DDRCFLUX_REGISTERS_LACERTA_H__

#define DDR_DMSS_BASE_ADDR	SOC_ACPU_DMSS_BASE_ADDR
#define DDR_REG_EXMBIST	(DDR_DMSS_BASE_ADDR + 0x18000)

#define PLATFORM_LIST \
	{ .compatible = "hisilicon,lacerta-ddrc-flux", }, \
	{ },

#define DDRC_PLATFORM_NAME		LACERTA
