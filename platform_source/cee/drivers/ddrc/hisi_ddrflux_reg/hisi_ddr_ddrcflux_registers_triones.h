/*
 * hisi_ddr_ddrcflux_registers_triones.h
 *
 * ddrcflux registers message for triones
 *
 ...
 *
 */
#ifndef __HISI_DDR_DDRCFLUX_REGISTERS_TRIONES_H__
#define __HISI_DDR_DDRCFLUX_REGISTERS_TRIONES_H__

#define PLATFORM_LIST \
	{ .compatible = "hisilicon,triones-ddrc-flux", }, \
	{ },

#define DDRC_PLATFORM_NAME		TRIONES
#define DDRC_IRQ_CPU_CORE_NUM		4
#define DDRC_DMC_NUM		1
#define DDRC_ASI_PORT_NUM		8
#define DDRC_QOSB_NUM		1

#define DDRC_QOSB_PLATFORM
#define DDRC_WITH_1CH
