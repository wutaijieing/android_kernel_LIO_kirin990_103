...
out:
	...
	page_trace_hook(gfp_mask, (unsigned char)DFX_MEM_ALLOC, _RET_IP_, page, order);
#endif
...
#ifdef CONFIG_DFX_MEM_TRACE
		page_trace_hook(__GFP_HIGHMEM, (unsigned char)DFX_MEM_FREE, _RET_IP_, page, order);/*lint !e571*/
#endif
