...
void vfree(const void *addr)
{
	...
	vmalloc_trace_hook((unsigned char)DFX_MEM_FREE, _RET_IP_, (unsigned long)addr, 0, (unsigned long long)0);/*lint !e571*/
#endif
}
EXPORT_SYMBOL(vfree);
...
#ifdef CONFIG_DFX_MEM_TRACE
	vmalloc_trace_hook((unsigned char)DFX_MEM_ALLOC, (unsigned long)caller, (unsigned long)addr,
